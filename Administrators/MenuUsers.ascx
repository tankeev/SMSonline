<%@ Control Language="VB" AutoEventWireup="false" CodeFile="MenuUsers.ascx.vb" Inherits="Administrators_MenuAdministrators" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>

<table class="content-table" width="240">
    <tr>
        <td width="60" height="50">
            <asp:HyperLink ID="HyperLinkUsersSearch" runat="server" ImageUrl="~/Administrators/Images/menu_search.png"
                NavigateUrl="~/Administrators/UsersSearch.aspx"></asp:HyperLink>
        </td>
        <td width="60">
            <asp:HyperLink ID="HyperLinkStudents" runat="server" ImageUrl="~/Administrators/Images/menu_students.png"
                NavigateUrl="~/Administrators/UsersStudents.aspx"></asp:HyperLink>
        </td>
        <td width="60">
            <asp:HyperLink ID="HyperLinkStaff" runat="server" ImageUrl="~/Administrators/Images/menu_details.png"
                NavigateUrl="~/Administrators/UsersStaff.aspx"></asp:HyperLink>
        </td>
        <td width="60">
            <asp:HyperLink ID="HyperLinkParents" runat="server" ImageUrl="~/Administrators/Images/menu_parents.png"
                NavigateUrl="~/Administrators/UsersParents.aspx"></asp:HyperLink>
        </td>
    </tr>
</table>
<br />
<table class="content-table" width="240">
    <tr>
        <td width="40">
            <asp:HyperLink ID="HyperLinkStudentsTable" runat="server" ImageUrl="~/Administrators/Images/menu_attendance_checklist.png"
                NavigateUrl="~/Administrators/UsersAccounts.aspx" ToolTip="User Accounts"></asp:HyperLink>
        </td>
        <td>
