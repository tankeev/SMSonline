...
<table class="content-table" width="240">
    <tr>
        <td height="50" width="60">
            <asp:HyperLink ID="HyperLinkAssessmentsByStudents" runat="server" ImageUrl="~/Administrators/Images/menu_assessments_students.png"
                NavigateUrl="~/Administrators/AssessmentsByStudents.aspx"></asp:HyperLink>
        </td>
        <td width="60">
            <asp:HyperLink ID="HyperLinkAssessmentsByCourses" runat="server" ImageUrl="~/Administrators/Images/menu_assessments_courses.png"
                NavigateUrl="~/Administrators/AssessmentsByCourses.aspx"></asp:HyperLink>
        </td>
        <td width="60">
            <asp:HyperLink ID="HyperLinkAssessmentsTeachers" runat="server" ImageUrl="~/Administrators/Images/menu_assessments_teachers.png"
                NavigateUrl="~/Administrators/AssessmentsByTeachers.aspx"></asp:HyperLink>
        </td>
        <td width="60">
            <asp:HyperLink ID="HyperLinkAssessmentsTypes" runat="server" ImageUrl="~/Administrators/Images/menu_assessments_types.png"
                NavigateUrl="~/Administrators/AssessmentTypesSchools.aspx"></asp:HyperLink>
        </td>
    </tr>
</table>
