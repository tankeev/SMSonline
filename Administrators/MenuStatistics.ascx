<%@ Control Language="VB" AutoEventWireup="false" CodeFile="MenuStatistics.ascx.vb"
...
<table class="content-table" width="240">
    ...
    <tr>
        <td width="60" height="50" align="center">
            <asp:HyperLink ID="HyperLinkAttendanceChecklist" runat="server" ImageUrl="~/Administrators/Images/menu_attendance_checklist.png"
                NavigateUrl="~/Administrators/AttendanceChecklist.aspx"></asp:HyperLink>
        </td>
        <td width="60" align="center">
            <asp:HyperLink ID="HyperLinkAttendanceArchive" runat="server" ImageUrl="~/Administrators/Images/menu_attendance_archive.png"
                NavigateUrl="~/Administrators/AttendanceArchive.aspx"></asp:HyperLink>
        </td>
        <td width="60" align="center">
            <asp:HyperLink ID="HyperLinkAttendanceReports" runat="server" ImageUrl="~/Administrators/Images/menu_attendance_reports.png"
                NavigateUrl="~/Administrators/AttendanceReports.aspx"></asp:HyperLink>
        </td>
        <td align="center" width="60">
            <asp:HyperLink ID="HyperLinkAttendanceJournals" runat="server" ImageUrl="~/Administrators/Images/menu_attendance_journal.png"
                NavigateUrl="~/Administrators/AttendanceJournals.aspx"></asp:HyperLink>
        </td>
    </tr>
</table>
