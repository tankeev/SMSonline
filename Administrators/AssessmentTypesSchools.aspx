<%@ Page Title="SIS School Assessment Types" Language="VB" MasterPageFile="~/Site.Master"
    AutoEventWireup="false" CodeFile="AssessmentTypesSchools.aspx.vb" Inherits="AssessmentTypesSchools" %>
        ...
        <ContentTemplate>
            <div class="content-left">
                ...
                <table class="content-table" width="240">
                    ...
                    <tr>
                        <td width="40">
                            <asp:HyperLink ID="HyperLinkAddNew" runat="server" ImageUrl="~/Administrators/Images/menu_school.png"
                                NavigateUrl="~/Administrators/MPEResultsByCourses.aspx">Add New</asp:HyperLink>
                        </td>
                        <td>
                            <asp:Label ID="Label23" runat="server" Text="Mitra Pasiad Exams"></asp:Label>
                        </td>
                    </tr>
                </table>
                <br />
                <table class="content-table" width="240">
                    <tr>
                        <td height="28">
                            <asp:Label ID="Label30" runat="server" Text="Given Courses"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <asp:ListBox ID="ListBoxCourses" runat="server" AutoPostBack="True" DataSourceID="SqlDataSourceCourses"
                                DataTextField="CourseCategory" DataValueField="CourseCategory" Height="240px"
            ...
            <div class="content-right">
                        ...
                        <asp:TemplateField ShowHeader="False">
                            <ItemTemplate>
                                <asp:ImageButton ID="ImageButtonSave0" runat="server" CommandName="Update"
                                    ImageUrl="~/Administrators/Images/save.gif" ToolTip="Update!" ValidationGroup="Update" />
                                <br />
                            </ItemTemplate>
                            <FooterTemplate>
                ...
                <table width="680">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Label ID="LabelWeekNo2" runat="server" Font-Bold="True" Text="Percentage:"></asp:Label>
                        </td>
                        <td>
                ...
                <asp:SqlDataSource ID="SqlDataSourceCourses" runat="server" ConnectionString="<%$ ConnectionStrings:SMSOnlineConnectionString %>"
                    SelectCommand="SELECT DISTINCT CourseCategory FROM vw_Courses WHERE (AcademicTermID = @AcademicTermID) AND (SchoolCode = @SchoolCode) ORDER BY CourseCategory">
                    <SelectParameters>
                ...
                <asp:SqlDataSource ID="SqlDataSourceCheckBoxListCourseSections" runat="server" ConnectionString="<%$ ConnectionStrings:SMSOnlineConnectionString %>"
                    SelectCommand="SELECT CourseSectionID, CourseCategory + N' ' + SectionCatalog AS CourseSection FROM vw_CourseSections WHERE (SchoolCode = @SchoolCode) AND (CourseCategory = @CourseCategory) AND (AcademicTermID = @AcademicTermID) ORDER BY SectionGroup, CourseCategory + N' ' + SectionCatalog">
                    <SelectParameters>
                        <asp:ControlParameter ControlID="DropDownListSchoolCodesMaster" Name="SchoolCode"
                            PropertyName="SelectedValue" />
                        <asp:ControlParameter ControlID="ListBoxCourses" Name="CourseCategory" PropertyName="SelectedValue" />
