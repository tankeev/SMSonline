        ...
        <ContentTemplate>
            ...
            <div class="content-right">
                <h2>
                    ADD STAFF</h2>
                <br />
                <asp:CreateUserWizard ID="CreateUserWizardStaff" runat="server" ContinueDestinationPageUrl="~/Administrators/Staff.aspx"
                        ...
                        <asp:CreateUserWizardStep runat="server">
                            <ContentTemplate>
                                <table id="AdministratorsTable" width="680">
                                    ...
                                    <tr>
                                        <td height="28">
                                            <asp:Image ID="Image31" runat="server" ImageUrl="~/Administrators/Images/LeftArrow.png" />
                                        </td>
                                        <td>
