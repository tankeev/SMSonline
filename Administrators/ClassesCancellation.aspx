<%@ Page Title="SIS Students" Language="VB" MasterPageFile="~/Site.Master" CodeFile="ClassesCancellation.aspx.vb"
    Inherits="Students" %>
                                        ...
                                        <tr>
                                            ...
                                            <td class="style1" colspan="3">
                                                <asp:TextBox ID="TextBoxAddress" runat="server" Height="60px" meta:resourceKey="TextBox4Resource1"
                                                    Text='<%# Bind("ContactAddress") %>' TextMode="MultiLine" Width="98%"></asp:TextBox>Administrators
                                                Administrators
                                            </td>
                                            <td class="style1">
                                                Administrators
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3">
                                                <asp:TextBox ID="TextBoxHealthIssues" runat="server" Height="60px" meta:resourceKey="TextBox9Resource1"
                                                    Text='<%# Bind("HealthIssues") %>' TextMode="MultiLine" Width="98%"></asp:TextBox>Administrators
                                                Administrators
                                            </td>
                                            <td>
                                                Administrators
