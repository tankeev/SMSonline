        ...
        <ContentTemplate>
            <div class="content-left">
                ...
                <table class="content-table" width="240">
                    <tr>
                        <td height="28">
                            <asp:Label ID="Label42" runat="server" Text="Select Date:" Font-Bold="True" ForeColor="Red"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td height="28">
                            <asp:Label ID="Label44" runat="server" Text="Select Section:" Font-Bold="True" ForeColor="Red"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>
            ...
            <div class="content-right">
                ...
                <br />
                <table width="680" style="border: 1px Solid #808080; background-color: #CCCCCC;">
                    <tr>
                        <td align="right">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="1" SortExpression="1">
                            <ItemTemplate>
                                ...
                                <asp:HoverMenuExtender ID="DDLP1_HoverMenuExtender" runat="server" TargetControlID="DDLP1"
                                    PopupPosition="Left" OffsetX="0" OffsetY="0" PopDelay="50" PopupControlID="PanelTooltip1">
                                </asp:HoverMenuExtender>
                                <asp:Panel ID="PanelTooltip1" runat="server" Width="200px" CssClass="popupMenu">
                                    <table width="100%">
                                        <tr>
                                            ...
                                            <td height="25">
                                                <asp:Label ID="Label1261" runat="server" Font-Bold="True" Text="Attendance Taken By:"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td height="30">
                                            ...
                                            <td height="30">
                                                <asp:Label ID="Label31" runat="server" Text='<%# Bind("1") %>' ForeColor="Red"></asp:Label>
                                            </td>
                                        </tr>
                                    </table>
                                </asp:Panel>
                        ...
                        <asp:TemplateField HeaderText="2" SortExpression="2">
                            <ItemTemplate>
                                ...
                                <asp:HoverMenuExtender ID="DDLP2_HoverMenuExtender" runat="server" TargetControlID="DDLP2"
                                    PopupControlID="PanelTooltip2">
                                </asp:HoverMenuExtender>
                                <asp:Panel ID="PanelTooltip2" runat="server" Width="200px" CssClass="popupMenu">
                                    <table width="100%">
                                        <tr>
                                            <td height="25" width="20">
                                            ...
                                            <td height="25">
                                                <asp:Label ID="Label1226" runat="server" Font-Bold="True" Text="Attendance Taken By:"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td height="30">
                                            ...
                                            <td height="30">
                                                <asp:Label ID="Label23" runat="server" Text='<%# Bind("2") %>' ForeColor="Red"></asp:Label>
                                            </td>
                                        </tr>
                                    </table>
                                </asp:Panel>
                        ...
                        <asp:TemplateField HeaderText="3" SortExpression="3">
                            <ItemTemplate>
                                ...
                                <asp:HoverMenuExtender ID="DDLP3_HoverMenuExtender" runat="server" TargetControlID="DDLP3"
                                    PopupControlID="PanelTooltip3">
                                </asp:HoverMenuExtender>
                                <asp:Panel ID="PanelTooltip3" runat="server" Width="200px" CssClass="popupMenu">
                                    <table width="100%">
                                        <tr>
                                            <td height="25" width="20">
                                            ...
                                            <td height="25">
                                                <asp:Label ID="La3bel126" runat="server" Font-Bold="True" Text="Attendance Taken By:"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td height="30">
                                            ...
                                            <td height="30">
                                                <asp:Label ID="Lab3el3" runat="server" Text='<%# Bind("3") %>' ForeColor="Red"></asp:Label>
                                            </td>
                                        </tr>
                                    </table>
                                </asp:Panel>
                        ...
                        <asp:TemplateField HeaderText="4" SortExpression="4">
                            <ItemTemplate>
                                ...
                                <asp:HoverMenuExtender ID="DDLP4_HoverMenuExtender" runat="server" TargetControlID="DDLP4"
                                    PopupControlID="PanelTooltip4">
                                </asp:HoverMenuExtender>
                                <asp:Panel ID="PanelTooltip4" runat="server" Width="200px" CssClass="popupMenu">
                                    <table width="100%">
                                        <tr>
                                            <td height="25" width="20">
                                            ...
                                            <td height="25">
                                                <asp:Label ID="Labe4l126" runat="server" Font-Bold="True" Text="Attendance Taken By:"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td height="30">
                                            ...
                                            <td height="30">
                                                <asp:Label ID="Lab4el3" runat="server" Text='<%# Bind("4") %>' ForeColor="Red"></asp:Label>
                                            </td>
                                        </tr>
                                    </table>
                                </asp:Panel>
                        ...
                        <asp:TemplateField HeaderText="5" SortExpression="5">
                            <ItemTemplate>
                                ...
                                <asp:HoverMenuExtender ID="DDLP5_HoverMenuExtender" runat="server" TargetControlID="DDLP5"
                                    PopupControlID="PanelTooltip5">
                                </asp:HoverMenuExtender>
                                <asp:Panel ID="PanelTooltip5" runat="server" Width="200px" CssClass="popupMenu">
                                    <table width="100%">
                                        <tr>
                                            <td height="25" width="20">
                                            ...
                                            <td height="25">
                                                <asp:Label ID="La5bel126" runat="server" Font-Bold="True" Text="Attendance Taken By:"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td height="30">
                                            ...
                                            <td height="30">
                                                <asp:Label ID="Lab5el3" runat="server" Text='<%# Bind("5") %>' ForeColor="Red"></asp:Label>
                                            </td>
                                        </tr>
                                    </table>
                                </asp:Panel>
                        ...
                        <asp:TemplateField HeaderText="6" SortExpression="6">
                            <ItemTemplate>
                                ...
                                <asp:HoverMenuExtender ID="DDLP6_HoverMenuExtender" runat="server" TargetControlID="DDLP6"
                                    PopupControlID="PanelTooltip6">
                                </asp:HoverMenuExtender>
                                <asp:Panel ID="PanelTooltip6" runat="server" Width="200px" CssClass="popupMenu">
                                    <table width="100%">
                                        <tr>
                                            <td height="25" width="20">
                                            ...
                                            <td height="25">
                                                <asp:Label ID="Label6126" runat="server" Font-Bold="True" Text="Attendance Taken By:"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td height="30">
                                            ...
                                            <td height="30">
                                                <asp:Label ID="Lab6el3" runat="server" Text='<%# Bind("6") %>' ForeColor="Red"></asp:Label>
                                            </td>
                                        </tr>
                                    </table>
                                </asp:Panel>
                        ...
                        <asp:TemplateField HeaderText="7" SortExpression="7">
                            <ItemTemplate>
                                ...
                                <asp:HoverMenuExtender ID="DDLP7_HoverMenuExtender" runat="server" TargetControlID="DDLP7"
                                    PopupControlID="PanelTooltip7">
                                </asp:HoverMenuExtender>
                                <asp:Panel ID="PanelTooltip7" runat="server" Width="200px" CssClass="popupMenu">
                                    <table width="100%">
                                        <tr>
                                            <td height="25" width="20">
                                            ...
                                            <td height="25">
                                                <asp:Label ID="Label1276" runat="server" Font-Bold="True" Text="Attendance Taken By:"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td height="30">
                                            ...
                                            <td height="30">
                                                <asp:Label ID="Label73" runat="server" Text='<%# Bind("7") %>' ForeColor="Red"></asp:Label>
                                            </td>
                                        </tr>
                                    </table>
                                </asp:Panel>
                        ...
                        <asp:TemplateField HeaderText="8" SortExpression="8">
                            <ItemTemplate>
                                ...
                                <asp:HoverMenuExtender ID="DDLP8_HoverMenuExtender" runat="server" TargetControlID="DDLP8"
                                    PopupControlID="PanelTooltip8">
                                </asp:HoverMenuExtender>
                                <asp:Panel ID="PanelTooltip8" runat="server" Width="200px" CssClass="popupMenu">
                                    <table width="100%">
                                        <tr>
                                            <td height="25" width="20">
                                            ...
                                            <td height="25">
                                                <asp:Label ID="Label8126" runat="server" Font-Bold="True" Text="Attendance Taken By:"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td height="30">
                                            ...
                                            <td height="30">
                                                <asp:Label ID="Lab8el3" runat="server" Text='<%# Bind("8") %>' ForeColor="Red"></asp:Label>
                                            </td>
                                        </tr>
                                    </table>
                                </asp:Panel>
                        ...
                        <asp:TemplateField HeaderText="9" SortExpression="9">
                            <ItemTemplate>
                                ...
                                <asp:HoverMenuExtender ID="DDLP9_HoverMenuExtender" runat="server" TargetControlID="DDLP9"
                                    PopupPosition="Left" OffsetX="0" OffsetY="0" PopDelay="50" PopupControlID="PanelTooltip9">
                                </asp:HoverMenuExtender>
                                <asp:Panel ID="PanelTooltip9" runat="server" Width="200px" CssClass="popupMenu">
                                    <table width="100%">
                                        <tr>
                                            <td height="25" width="20">
                                            ...
                                            <td height="25">
                                                <asp:Label ID="L9abel126" runat="server" Font-Bold="True" Text="Attendance Taken By:"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td height="30">
                                            ...
                                            <td height="30">
                                                <asp:Label ID="La9bel3" runat="server" Text='<%# Bind("9") %>' ForeColor="Red"></asp:Label>
                                            </td>
                                        </tr>
                                    </table>
                                </asp:Panel>
                ...
                <br />
                <asp:Panel ID="PanelInsertAll" runat="server" Visible="False" Width="680px">
                    <br />
                    ...
                    <asp:DropDownList ID="DropDownListATAll" runat="server" DataSourceID="SqlDataSourceAttendanceTypes"
                        DataTextField="AttendanceType" DataValueField="AttendanceTypeID" Width="680px">
                        <asp:ListItem Value="">?</asp:ListItem>
                    </asp:DropDownList>
                    <br />
                    <br />
                    <asp:Button ID="ButtonInsertAll" runat="server" Text="Insert All Periods" Width="680px" />
                    <br />
                    <br />
                    <asp:Label ID="LabelStatusInsertAll" runat="server" Font-Bold="True" ForeColor="#CC0000"></asp:Label>
                    <br />
                    <br />
                </asp:Panel>
                ...
                <asp:SqlDataSource ID="SqlDataSourceStudents" runat="server" ConnectionString="<%$ ConnectionStrings:SMSOnlineConnectionString %>"
                    SelectCommand="SELECT StudentID, StudentName, [1], [2], [3], [4], [5], [6], [7], [8], [9] FROM vw_Attendance WHERE (Date = @Date) AND (SchoolCode = @SchoolCode) AND (CurrentSectionID = @CurrentSectionID) ORDER BY StudentName"
