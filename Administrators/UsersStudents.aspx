<%@ Page Title="SIS Students" Language="VB" MasterPageFile="~/Site.Master" CodeFile="UsersStudents.aspx.vb"
    Inherits="Students" %>
        ...
        <ContentTemplate>
            <div class="content-left">
                ...
                <table class="content-table" width="240">
                    <tr>
                        <td width="40">
                            <asp:HyperLink ID="HyperLinkStudentAdd" runat="server" ImageUrl="~/Administrators/Images/menu_add.png"
                                NavigateUrl="~/Administrators/StudentsAdd.aspx" ToolTip="Add New Student"></asp:HyperLink>
                        </td>
                        <td>
                            <asp:Label ID="Label81" runat="server" Text="Add New Student"></asp:Label>
                        </td>
                    </tr>
                </table>
                <br />
                <table class="content-table" width="240">
                    <tr>
                        <td height="28">
                            <asp:CheckBox ID="CheckBoxSD" runat="server" AutoPostBack="True" Text="SD" Checked="True"
                                Enabled="False" />
                        </td>
                        <td>
                            <asp:CheckBox ID="CheckBoxSMP" runat="server" AutoPostBack="True" Text="SMP" Checked="True"
                                Enabled="False" />
                        </td>
                        <td>
                            <asp:CheckBox ID="CheckBoxSMA" runat="server" AutoPostBack="True" Text="SMA" Checked="True"
                                Enabled="False" />
                        </td>
                    </tr>
                    <tr>
                        <td colspan="3" height="28">
                            <asp:CheckBox ID="CheckBoxFilter" runat="server" AutoPostBack="True" Text="Filter Students By Section?"
                                Checked="True" />
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="3">
                            <asp:ListBox ID="ListBoxStudents" runat="server" AutoPostBack="True" DataSourceID="SqlDataSourceListBoxStudents"
                                DataTextField="StudentName" DataValueField="StudentID" Height="240px" Width="95%">
                            </asp:ListBox>
                        </td>
                    </tr>
                    <tr>
            ...
            <div class="content-right">
                <h2>
                    STUDENT DETAILS</h2>
                <br />
                <asp:TabContainer ID="TabContainerStudents" runat="server" ActiveTabIndex="0" Width="680px"
                    CssClass="tab">
                            ...
                            <asp:FormView ID="FormViewStudentsBasicInformation" runat="server" DataSourceID="SqlDataSourceFormViewStudentsBasicInformation"
                                    ...
                                    <table id="tblBasicInformation" width="100%">
                                        <tr>
                                            ...
                                            <td rowspan="15" valign="top">
                                                <img alt='<%# Eval("StudentName") %>' height="240" src="../SchoolData/StudentPhotos/000.jpg"
                                                    style="border: 3px solid #C0C0C0" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image29" runat="server" ImageUrl="~/Administrators/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <asp:TextBox ID="TextBoxSchoolNo" runat="server" Text='<%# Bind("SchoolNo") %>' Width="220px"></asp:TextBox>
                                            </td>
                                            <td>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="TextBoxDateofBirth" runat="server" MaxLength="50" meta:resourceKey="TextBoxStudentNameResource1"
                                                    Text='<%# Bind("DateofBirth", "{0:d}") %>' Width="220px"></asp:TextBox><asp:CalendarExtender
                                                        ID="TextBoxDateofBirth_CalendarExtender" runat="server" Enabled="True" TargetControlID="TextBoxDateofBirth">
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image33" runat="server" ImageUrl="~/Administrators/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image34" runat="server" ImageUrl="~/Administrators/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <asp:TextBox ID="TextBoxScholarshipPercentage" runat="server" MaxLength="50" Text='<%# Bind("ScholarshipPercentage") %>'
                                                    Width="220px"></asp:TextBox><asp:SliderExtender ID="TextBoxPercentage_SliderExtender"
                                                        runat="server" BoundControlID="TextBoxSliderValue" Enabled="True" EnableHandleAnimation="True"
                                                        Length="230" Maximum="100" Minimum="0" TargetControlID="TextBoxScholarshipPercentage"
                                                        TooltipText="Percentage: {0}">
                                                    </asp:SliderExtender>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Button ID="ButtonUpdate" runat="server" CommandName="Update" Text="Update" Width="220px" />
                                            </td>
                                            <td>
                                            </td>
                                        </tr>
                                ...
                                <EmptyDataTemplate>
                                    <div align="center">
                                        ...
                                        <br />
                                        <br />
                                        <asp:Label ID="LabelWarning" runat="server" Font-Bold="True" Text="Please Select a Student from the List to see the Records!"
                            ...
                            <asp:FormView ID="FormViewStudentsAdditionalInformation" runat="server" DataKeyNames="StudentID"
                                ...
                                <EditItemTemplate>
                                    <table id="tblAdditionalInformation" width="100%">
                                        <tr>
                                            <td height="30" width="20">
                                                <asp:Image ID="Image91" runat="server" ImageUrl="~/Administrators/Images/LeftArrow.png" />
                                            </td>
                                            <td width="140">
                                        ...
                                        <tr>
                                            <td height="30" width="20">
                                                <asp:Image ID="Image93" runat="server" ImageUrl="~/Administrators/Images/LeftArrow.png" />
                                            </td>
                                            <td width="120">
                                        ...
                                        <tr>
                                            <td height="30" width="20">
                                                <asp:Image ID="Image95" runat="server" ImageUrl="~/Administrators/Images/LeftArrow.png" />
                                            </td>
                                            <td width="120">
                                        ...
                                        <tr>
                                            <td valign="top" width="20">
                                                <asp:Image ID="Image126" runat="server" ImageUrl="~/Administrators/Images/LeftArrow.png" />
                                            </td>
                                        ...
                                        <tr>
                                            <td height="28" valign="top" width="20">
                                                <asp:Image ID="Image127" runat="server" ImageUrl="~/Administrators/Images/LeftArrow.png" />
                                            </td>
                                            <td valign="top" width="120">
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3">
                                                <asp:Button ID="ButtonUpdate" runat="server" CommandName="Update" Text="Update" Width="98%" />
                                            </td>
                                            <td>
                                            </td>
                                        </tr>
                            ...
                            <asp:FormView ID="FormViewStudentsEnrollmentDetails" runat="server" DataKeyNames="StudentID"
                                ...
                                <EditItemTemplate>
                                    <table id="tblEnrollmentDetails0" width="100%">
                                        <tr>
                                            ...
                                            <td width="240">
                                                <asp:TextBox ID="TextBoxEnrollmentDate" runat="server" MaxLength="50" Text='<%# Bind("EnrollmentDate", "{0:d}") %>'
                                                    Width="220px"></asp:TextBox><asp:CalendarExtender ID="CalendarExtenderTextBoxEnrollmentDate0"
                                                        runat="server" Enabled="True" TargetControlID="TextBoxEnrollmentDate">
                                                    </asp:CalendarExtender>
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image81" runat="server" ImageUrl="~/Administrators/Images/LeftArrow.png" />
                                            </td>
                                            <td height="25">
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image82" runat="server" ImageUrl="~/Administrators/Images/LeftArrow.png" />
                                            </td>
                                            <td height="25">
                                        ...
                                        <tr>
                                            <td height="25" valign="top">
                                                <asp:Image ID="Image72" runat="server" ImageUrl="~/Administrators/Images/LeftArrow.png" />
                                            </td>
                                            <td height="75" valign="top">
                    ...
                    <asp:TabPanel ID="TabPanelGuardian" runat="server" HeaderText="Guardian Information">
                        ...
                        <ContentTemplate>
                            <asp:FormView ID="FormViewParentsGuardianDetails" runat="server" DataSourceID="SqlDataSourceFormViewParentsInformationGuardiansDetails"
                                DefaultMode="Edit" DataKeyNames="ResponsibleParentID" Width="100%">
                                <EditItemTemplate>
                                    <table id="tblGuardiansDetails0" width="100%">
                                        <tr>
                                            <td height="30" width="20">
                                                <asp:Image ID="Image96" runat="server" ImageUrl="~/Administrators/Images/LeftArrow.png" />
                                            </td>
                                            <td width="130">
                                            ...
                                            <td width="20">
                                                <asp:Image ID="Image124" runat="server" ImageUrl="~/Administrators/Images/LeftArrow.png" />
                                            </td>
                                            <td width="130">
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image97" runat="server" ImageUrl="~/Administrators/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <asp:Image ID="Image125" runat="server" ImageUrl="~/Administrators/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td height="75" valign="top">
                                                <asp:Image ID="Image99" runat="server" ImageUrl="~/Administrators/Images/LeftArrow.png" />
                                            </td>
                                            <td valign="top">
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image46" runat="server" ImageUrl="~/Administrators/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                    ...
                    <asp:TabPanel ID="TabPanelParents" runat="server" HeaderText="TabPanelParents">
                        ...
                        <ContentTemplate>
                            <asp:FormView ID="FormViewParentsParentsInformation" runat="server" DataSourceID="SqlDataSourceFormViewParentsParentsInformation"
                                DefaultMode="Edit" Width="100%" DataKeyNames="ResponsibleParentID">
                                <EditItemTemplate>
                                    <table id="StudentTable1" width="100%">
                                        <tr>
                                            <td height="30" width="20">
                                                <asp:Image ID="Image128" runat="server" ImageUrl="~/Administrators/Images/LeftArrow.png" />
                                            </td>
                                            <td width="130">
                                            ...
                                            <td width="20">
                                                <asp:Image ID="Image129" runat="server" ImageUrl="~/Administrators/Images/LeftArrow.png" />
                                            </td>
                                            <td width="130">
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image105" runat="server" ImageUrl="~/Administrators/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <asp:Image ID="Image106" runat="server" ImageUrl="~/Administrators/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image110" runat="server" ImageUrl="~/Administrators/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <asp:Image ID="Image109" runat="server" ImageUrl="~/Administrators/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image130" runat="server" ImageUrl="~/Administrators/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <asp:Image ID="Image90" runat="server" ImageUrl="~/Administrators/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image103" runat="server" ImageUrl="~/Administrators/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <asp:Image ID="Image104" runat="server" ImageUrl="~/Administrators/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td height="30" valign="top">
                                                <asp:Image ID="Image131" runat="server" ImageUrl="~/Administrators/Images/LeftArrow.png" />
                                            </td>
                                            <td valign="top">
                                            ...
                                            <td valign="top">
                                                <asp:Image ID="Image132" runat="server" ImageUrl="~/Administrators/Images/LeftArrow.png" />
                                            </td>
                                            <td valign="top">
                                        ...
                                        <tr>
                                            <td height="30" valign="top">
                                                <asp:Image ID="Image107" runat="server" ImageUrl="~/Administrators/Images/LeftArrow.png" />
                                            </td>
                                            <td valign="top">
                                            ...
                                            <td valign="top">
                                                <asp:Image ID="Image108" runat="server" ImageUrl="~/Administrators/Images/LeftArrow.png" />
                                            </td>
                                            <td valign="top">
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image133" runat="server" ImageUrl="~/Administrators/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <asp:Image ID="Image134" runat="server" ImageUrl="~/Administrators/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image135" runat="server" ImageUrl="~/Administrators/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <asp:Image ID="Image136" runat="server" ImageUrl="~/Administrators/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image137" runat="server" ImageUrl="~/Administrators/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <asp:Image ID="Image98" runat="server" ImageUrl="~/Administrators/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image138" runat="server" ImageUrl="~/Administrators/Images/LeftArrow.png" />
                                            </td>
                                            <td height="28">
                                            ...
                                            <td height="28">
                                                <asp:Image ID="Image100" runat="server" ImageUrl="~/Administrators/Images/LeftArrow.png" />
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td height="28">
                                                <asp:Button ID="ButtonUpdate0" runat="server" CommandName="Update" Text="Update"
                                                    Width="150px" />
                                            </td>
                                            <td height="28">
                                            </td>
                ...
                <asp:SqlDataSource ID="SqlDataSourceListBoxStudents" runat="server" ConnectionString="<%$ ConnectionStrings:SMSOnlineConnectionString %>"
                    SelectCommand="SELECT StudentID, StudentName, CurrentSectionID FROM vw_Students WHERE (SchoolCode = @SchoolCode) AND (SectionSchool = @IsSD OR SectionSchool = @IsSMP OR SectionSchool = @IsSMA) AND ([Continue] = 1) ORDER BY StudentName"
                    FilterExpression="CurrentSectionID={0}">
                    <FilterParameters>
                        <asp:ControlParameter ControlID="DropDownListSections" Name="FilterSections" PropertyName="SelectedValue" />
                    </FilterParameters>
                    <SelectParameters>
                        <asp:ControlParameter ControlID="DropDownListSchoolCodesMaster" Name="SchoolCode"
