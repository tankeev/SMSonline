...
Partial Class Staff
    ...
    Protected Sub ListBoxStaff_DataBound(ByVal sender As Object, ByVal e As System.EventArgs) Handles ListBoxStaff.DataBound
        Try
    ...
    Protected Sub ListBoxStaff_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ListBoxStaff.SelectedIndexChanged
        Try
    ...
    Protected Sub FormViewStaff_ItemUpdated(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.FormViewUpdatedEventArgs) Handles FormViewStaffOverview.ItemUpdated, FormViewStaffAdditional.ItemUpdated, FormViewStaffAcademic.ItemUpdated
    ...
    Protected Sub FormViewStaffAdditional_ItemUpdating(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.FormViewUpdateEventArgs) Handles FormViewStaffAdditional.ItemUpdating
    ...
    Protected Sub UpdateRoles_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles UpdateRoles.Click
        Try
            For Each item As ListItem In CheckBoxListRoles.Items
                ...
                End If
            Next
            WebMessageBoxStaff.Show("Roles Updated Successfully!", "Success")
        Catch ex As Exception
    ...
    Protected Sub ButtonUploadPhoto_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Dim FileUploadPhoto As FileUpload = FormViewStaffAdditional.FindControl("FileUploadPhoto")
        Dim LabelStatusPhoto As Label = FormViewStaffAdditional.FindControl("LabelStatusPhoto")
        Dim TextBoxPhotoURL As TextBox = FormViewStaffAdditional.FindControl("TextBoxPhotoURL")
        Dim ImagePhoto As Image = FormViewStaffAdditional.FindControl("ImagePhoto")
