        ...
        <ContentTemplate>
            <div class="content-left">
                ...
                <table class="content-table" width="240">
                    <tr>
                        <td height="28">
                            <asp:Label ID="Label36" runat="server" Font-Bold="True" ForeColor="Red" Text="Select School Level"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td height="28">
                            <asp:Label ID="Label135" runat="server" Font-Bold="True" ForeColor="Red" Text="Select School Section"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td height="28">
                            <asp:Label ID="Label134" runat="server" Font-Bold="True" Text="Select Section Course"
                ...
                <div id="divChild">
                    ...
                    <asp:GridView ID="GridViewAssessments" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:Image ID="ImageItem0" runat="server" ImageUrl="Images/Item.png" />
                                </ItemTemplate>
