<%@ Page Title="SIS User Accounts" Language="VB" MasterPageFile="~/Site.Master" CodeFile="UsersAccounts.aspx.vb"
    ValidateRequest="false" Inherits="ManageUsers" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <div class="content-left">
        ...
        <br />
        <uc2:MenuUsers ID="MenuUsers1" runat="server" />
        <br />
                ...
                <ContentTemplate>
                    <asp:GridView ID="GridviewParents" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSourceParents"
                        ...
                        <Columns>
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:Image ID="ImageInfo" runat="server" ImageUrl="~/Administrators/Images/info.png" />
