<%@ Page Title="SIS Parents" Language="VB" MasterPageFile="~/Site.Master" AutoEventWireup="false"
    CodeFile="UsersParents.aspx.vb" Inherits="NewUserAccount" %>
        ...
        <ContentTemplate>
            <div class="content-left">
                ...
                <table class="content-table" width="240">
                    <tr>
                        <td width="40">
                            <asp:HyperLink ID="HyperLinkParentAdd" runat="server" ImageUrl="~/Administrators/Images/menu_add.png"
                                NavigateUrl="~/Administrators/ParentsAdd.aspx" ToolTip="Add New Parent"></asp:HyperLink>
                        </td>
                        <td>
                            <asp:Label ID="Label132" runat="server" Text="Add New Parent"></asp:Label>
                        </td>
                    </tr>
                </table>
                <br />
                <table class="content-table" width="240">
                    <tr>
                        <td height="28">
                            <asp:TextBox ID="TextBoxSearchUser" runat="server" placeholder="Search Parent" Width="90%"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td height="28">
                            <asp:Button ID="ButtonSearch" runat="server" Text="Search Database" Width="95%" />
                        </td>
                    </tr>
                    <tr>
                        <td height="28">
                            <asp:Label ID="Label83" runat="server" Text="Parent List:"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <asp:ListBox ID="ListBoxParents" runat="server" AutoPostBack="True" DataSourceID="SqlDataSourceListBoxParents"
                                DataTextField="ResponsibleParent" DataValueField="ResponsibleParentID" Height="240px"
            ...
            <div class="content-right">
                                ...
                                <EmptyDataTemplate>
                                    <div align="center">
                                        ...
                                        <asp:Label ID="LabelWarning" runat="server" Font-Bold="True" Font-Size="Medium" ForeColor="Red"
                                            Text="Please Select a Parent from the List to see the Records!"></asp:Label>
                                        <br />
                                        <br />
                                    </div>
                                </EmptyDataTemplate>
                            ...
                            <asp:FormView ID="FormViewParentsAdditional" runat="server" DataKeyNames="ResponsibleParentID"
                                ...
                                <EditItemTemplate>
                                    <table id="StudentTable1" width="100%">
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image89" runat="server" ImageUrl="~/Administrators/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                ...
                                <EmptyDataTemplate>
                                    <div align="center">
                                        ...
                                        <br />
                                        <br />
                                        <asp:Label ID="LabelWarning" runat="server" Font-Bold="True" Text="Please Select a Parent from the List to see the Records!"
                ...
                <asp:SqlDataSource ID="SqlDataSourceListBoxParents" runat="server" ConnectionString="<%$ ConnectionStrings:SMSOnlineConnectionString %>"
                    SelectCommand="SELECT ResponsibleParentID, ResponsibleParent, SchoolCode, [Continue] FROM tbl_Parents WHERE (SchoolCode = @SchoolCode) AND ([Continue] = 1) ORDER BY ResponsibleParent">
                    <FilterParameters>
                        <asp:ControlParameter ControlID="TextBoxSearchUser" Name="SearchResponsibleParent"
                            PropertyName="Text" />
                    </FilterParameters>
                    <SelectParameters>
                ...
                <uc1:WebMessageBox ID="WebMessageBoxParents" runat="server" />
                <br />
