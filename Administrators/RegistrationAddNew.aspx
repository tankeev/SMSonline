<%@ Page Title="SIS Add New Student" Language="VB" MasterPageFile="~/Site.Master"
    CodeFile="RegistrationAddNew.aspx.vb" Inherits="NewUserAccount" %>
        ...
        <ContentTemplate>
            ...
            <div class="content-right">
                <h2>
                    ADMISSION FORM</h2>
                <br />
                <asp:CreateUserWizard ID="CreateUserWizardStudent" runat="server" ContinueDestinationPageUrl="~/Administrators/UsersStudents.aspx"
                    LoginCreatedUser="False" Width="680px">
                    <WizardSteps>
                        <asp:CreateUserWizardStep runat="server">
                            <ContentTemplate>
                                <asp:Label ID="Label3" runat="server" Text="Administrators INFORMATION" Font-Bold="True"
                                ...
                                <br />
                                <br />
                                <table id="AdministratorsTable0" width="100%">
                                    <tr>
                                        <td width="20" height="28">
                                            <asp:Image ID="Image56" runat="server" ImageUrl="~/Administrators/Images/LeftArrow.png" />
                                        </td>
                                        <td width="140">
                                    ...
                                    <tr>
                                        <td height="28">
                                            <asp:Image ID="Image57" runat="server" ImageUrl="~/Administrators/Images/LeftArrow.png" />
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td height="28">
                                            <asp:Image ID="Image112" runat="server" ImageUrl="~/Administrators/Images/LeftArrow.png" />
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td height="28">
                                            <asp:Image ID="Image113" runat="server" ImageUrl="~/Administrators/Images/LeftArrow.png" />
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td height="28">
                                            <asp:Image ID="Image114" runat="server" ImageUrl="~/Administrators/Images/LeftArrow.png" />
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td height="28">
                                            <asp:Image ID="Image115" runat="server" ImageUrl="~/Administrators/Images/LeftArrow.png" />
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td height="28">
                                            <asp:Image ID="Image116" runat="server" ImageUrl="~/Administrators/Images/LeftArrow.png" />
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td class="style1" height="28">
                                            <asp:Image ID="Image58" runat="server" ImageUrl="~/Administrators/Images/LeftArrow.png" />
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <asp:DropDownList ID="DropDownListSections" runat="server" DataSourceID="SqlDataSourceSections"
                                                DataTextField="SectionCategory" DataValueField="SectionCatalogID" TabIndex="8"
                                                Width="230px">
                                            </asp:DropDownList>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td height="28">
                                            <asp:Image ID="Image101" runat="server" ImageUrl="~/Administrators/Images/LeftArrow.png" />
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td height="28">
                                            <asp:Image ID="Image117" runat="server" ImageUrl="~/Administrators/Images/LeftArrow.png" />
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            ...
                                            <asp:SliderExtender ID="TextBoxPercentage_SliderExtender" runat="server" Enabled="True"
                                                ...
                                                TooltipText="Percentage: {0}" Length="230" EnableHandleAnimation="True">
                                            </asp:SliderExtender>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td height="28">
                                            <asp:Image ID="Image118" runat="server" ImageUrl="~/Administrators/Images/LeftArrow.png" />
                                        </td>
                                        <td>
                                ...
                                <table id="StudentTable" width="100%">
                                    <tr>
                                        <td width="20" height="28">
                                            <asp:Image ID="Image59" runat="server" ImageUrl="~/Administrators/Images/LeftArrow.png" />
                                        </td>
                                        <td width="140">
                                        ...
                                        <td width="20">
                                            <asp:Image ID="Image65" runat="server" ImageUrl="~/Administrators/Images/LeftArrow.png" />
                                        </td>
                                        <td width="140">
                                        ...
                                        <td>
                                            <asp:TextBox ID="TextBoxMotherName" runat="server" MaxLength="50" meta:resourcekey="TextBoxSexResource1"
                                                Text='<%# Bind("MotherName") %>' Width="150px"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td height="28">
                                            <asp:Image ID="Image60" runat="server" ImageUrl="~/Administrators/Images/LeftArrow.png" />
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <asp:TextBox ID="TextBoxFatherOccupation" runat="server" MaxLength="100" meta:resourcekey="TextBoxSexResource1"
                                                Text='<%# Bind("FatherOccupation") %>' Width="150px"></asp:TextBox>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <asp:TextBox ID="TextBoxMotherOccupation" runat="server" MaxLength="100" meta:resourcekey="TextBoxSexResource1"
                                                Text='<%# Bind("MotherOccupation") %>' Width="150px"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td height="28">
                                        ...
                                        <td>
                                            <asp:TextBox ID="TextBoxFatherCompany" runat="server" meta:resourcekey="TextBox2Resource1"
                                                Text='<%# Bind("MotherHandPhone") %>' Width="150px"></asp:TextBox>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td height="28">
                                            <asp:Image ID="Image61" runat="server" ImageUrl="~/Administrators/Images/LeftArrow.png" />
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td height="28">
                                            <asp:Image ID="Image62" runat="server" ImageUrl="~/Administrators/Images/LeftArrow.png" />
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <asp:TextBox ID="TextBoxFatherOfficeAddress" runat="server" meta:resourcekey="TextBox2Resource1"
                                                Text='<%# Bind("MotherHandPhone") %>' Width="150px" Height="60px" TextMode="MultiLine"></asp:TextBox>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <asp:TextBox ID="TextBoxMotherOfficeAddress" runat="server" meta:resourcekey="TextBox2Resource1"
                                                Text='<%# Bind("MotherHandPhone") %>' Width="150px" Height="60px"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td height="28">
                                            <asp:Image ID="Image63" runat="server" ImageUrl="~/Administrators/Images/LeftArrow.png" />
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td height="28">
                                            <asp:Image ID="Image8" runat="server" ImageUrl="~/Administrators/Images/LeftArrow.png" />
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <asp:Image ID="Image41" runat="server" ImageUrl="~/Administrators/Images/LeftArrow.png" />
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td height="28">
                                            <asp:Image ID="Image64" runat="server" ImageUrl="~/Administrators/Images/LeftArrow.png" />
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <asp:Image ID="Image43" runat="server" ImageUrl="~/Administrators/Images/LeftArrow.png" />
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <asp:TextBox ID="TextBoxMotherDateofBirth" runat="server" meta:resourcekey="TextBoxStartingGradeResource1"
                                                Text='<%# Bind("MotherDateofBirth") %>' Width="150px"></asp:TextBox>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:Image ID="Image44" runat="server" ImageUrl="~/Administrators/Images/LeftArrow.png" />
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <asp:TextBox ID="TextBoxMotherPlaceofBirth" runat="server" meta:resourcekey="TextBoxStartingGradeResource1"
                                                Text='<%# Bind("MotherPlaceofBirth") %>' Width="150px"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td height="28">
                                        ...
                                        <td>
                                            <asp:Image ID="Image45" runat="server" ImageUrl="~/Administrators/Images/LeftArrow.png" />
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td height="28">
                                            <asp:Image ID="Image35" runat="server" ImageUrl="~/Administrators/Images/LeftArrow.png" />
                                        </td>
                                        <td height="28">
                                        ...
                                        <td height="28">
                                            <asp:Image ID="Image38" runat="server" ImageUrl="~/Administrators/Images/LeftArrow.png" />
                                        </td>
                                        ...
                                        <td height="28">
                                            <asp:TextBox ID="TextBoxMotherReligion" runat="server" meta:resourcekey="TextBox1Resource2"
                                                Text='<%# Bind("MotherReligion") %>' Width="150px"></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
                                <br />
                                ...
                                <table id="StudentTable0" width="100%">
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList ID="DropDownListParentGender" runat="server" Width="150px">
                                    ...
                                    <tr>
                                        <td height="28" width="20">
                                            <asp:Image ID="Image119" runat="server" ImageUrl="~/Administrators/Images/LeftArrow.png" />
                                        </td>
                                        <td width="140">
                                        ...
                                        <td>
                                            <asp:TextBox ID="TextBoxContactPhone" runat="server" MaxLength="50" meta:resourcekey="TextBoxSexResource1"
                                                Text='<%# Bind("ContactPhone") %>' Width="150px"></asp:TextBox>
                                    ...
                                    <tr>
                                        <td height="28">
                                            <asp:Image ID="Image102" runat="server" ImageUrl="~/Administrators/Images/LeftArrow.png" />
                                        </td>
                                        <td height="28">
                                        ...
                                        <td height="28">
                                            <asp:TextBox ID="TextBoxContactEmail" runat="server" MaxLength="50" meta:resourcekey="TextBoxSexResource1"
                                                Text='<%# Bind("ContactEmail") %>' Width="150px"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td height="75">
                                ...
                                <table id="StudentTable1" width="100%">
                                    ...
                                    <tr>
                                        <td height="75" valign="top">
                                            <asp:Image ID="Image111" runat="server" ImageUrl="~/Administrators/Images/LeftArrow.png" />
                                        </td>
                                        <td valign="top">
