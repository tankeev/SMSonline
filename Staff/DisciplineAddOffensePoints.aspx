<%@ Page Title="SIS Add Discipline Points" Language="VB" MasterPageFile="~/Site.Master"
    CodeFile="DisciplineAddOffensePoints.aspx.vb" Inherits="Attendance_Checklist" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel" runat="server">
        <ContentTemplate>
            <div class="content-left">
                ...
                <table class="content-table" width="240">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Label ID="Label49" runat="server" Text="Behaviour Points"></asp:Label>
                        </td>
                    </tr>
                </table>
                <br />
                            ...
                            <ContentTemplate>
                                <table class="content-table" width="230">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:Label ID="Label1" runat="server" Text="Update Bonus Points"></asp:Label>
                                        </td>
                                    </tr>
                                </table>
                                <br />
                                <table class="content-table" width="230">
                                    ...
                                    <tr>
                                        <td width="40">
                                            <asp:HyperLink ID="HyperLinkAddNew0" runat="server" Enabled="False" ImageUrl="~/Staff/Images/button_orange.png"
                                                NavigateUrl="~/Staff/DisciplineAddOffensePoints.aspx">Add New</asp:HyperLink>
                                        </td>
                                        <td>
                                            <asp:Label ID="Label45" runat="server" ForeColor="Red" Text="Update Offense Points"></asp:Label>
                                        </td>
                                    </tr>
                                </table>
                                <br />
            ...
            <div class="content-right">
                ...
                <br />
                <asp:Button ID="ButtonAddRecords" runat="server" Text="Add Discipline Records" Width="680px" />
                <br />
                <br />
                <table width="680">
                    <tr>
                        ...
                        <td>
                            <asp:Label ID="Label46" runat="server" ForeColor="Red" Text="Use the button to add details to records."></asp:Label>
                        </td>
                    </tr>
                </table>
                <br />
...
ORDER BY SectionGroup">
                ...
                <asp:SqlDataSource ID="SqlDataSourceDisciplineTypes" runat="server" ConnectionString="<%$ ConnectionStrings:SMSOnlineConnectionString %>"
                    SelectCommand="SELECT DisciplineTypeID, DisciplineType, PointType, SchoolCode FROM tbl_DisciplineTypes WHERE (PointType = 0) AND (SchoolCode = @SchoolCode) ORDER BY DisciplineType">
                    <SelectParameters>
                        <asp:ControlParameter ControlID="DropDownListSchoolCodesMaster" Name="SchoolCode"
                            PropertyName="SelectedValue" />
                    </SelectParameters>
