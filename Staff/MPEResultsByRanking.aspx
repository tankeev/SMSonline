<%@ Page Title="SIS General Tests Ranking" Language="VB" MasterPageFile="~/Site.Master"
    CodeFile="MPEResultsByRanking.aspx.vb" Inherits="Assignments" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel" runat="server">
        <ContentTemplate>
            ...
            <div class="content-right">
                ...
                <asp:Panel ID="PanelRanking" runat="server" Visible="False" Width="680px">
                    ...
                    <asp:GridView ID="GridviewGeneralTestsRanking" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:Image ID="Image1" runat="server" ImageUrl="~/Staff/Images/Item.png" />
                                </ItemTemplate>
