<%@ Page Title="SIS Parents" Language="VB" MasterPageFile="~/Site.Master" AutoEventWireup="false"
    ValidateRequest="false" CodeFile="UsersParents.aspx.vb" Inherits="Users_Parents" %>
        ...
        <ContentTemplate>
            ...
            <div class="content-right">
                <h2>
                    PARENTS</h2>
                <br />
                <asp:TabContainer ID="TabContainerParents" runat="server" ActiveTabIndex="0" CssClass="tab"
                    Width="680px">
                            ...
                            <asp:FormView ID="FormViewParentsOverview" runat="server" DataKeyNames="ResponsibleParentID"
                                    ...
                                    <table id="StudentTable0" width="100%">
                                        <tr>
                                            <td height="30" width="20">
                                                <asp:Image ID="Image55" runat="server" ImageUrl="~/Staff/Images/LeftArrow.png" />
                                            </td>
                                            <td width="140">
                                            ...
                                            <td width="240">
                                                <asp:DropDownList ID="SchoolCode" runat="server" DataSourceID="SqlDataSourceFormViewParentsSchoolCodes"
                                        ...
                                        <tr>
                                            <td height="30" width="20">
                                                <asp:Image ID="Image65" runat="server" ImageUrl="~/Staff/Images/LeftArrow.png" />
                                            </td>
                                            <td width="140">
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image57" runat="server" ImageUrl="~/Staff/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image59" runat="server" ImageUrl="~/Staff/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image63" runat="server" ImageUrl="~/Staff/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image64" runat="server" ImageUrl="~/Staff/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td height="75" valign="top">
                                                <asp:Image ID="Image61" runat="server" ImageUrl="~/Staff/Images/LeftArrow.png" />
                                            </td>
                                            <td valign="top">
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image62" runat="server" ImageUrl="~/Staff/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                ...
                                <EmptyDataTemplate>
                                    <div align="center">
                                        ...
                                        <br />
                                        <br />
                                        <asp:Label ID="LabelWarning" runat="server" Font-Bold="True" Text="Please Select a Parent from the Menu on the Left to Load Data!"
                    ...
                    <asp:TabPanel ID="TabPanel3" runat="server" HeaderText="TabPanel3">
                        ...
                        <ContentTemplate>
                            <asp:FormView ID="FormViewParentsNotes" runat="server" DataKeyNames="ResponsibleParentID"
                                ...
                                <EditItemTemplate>
                                    <table id="StudentTable2" width="100%">
                                        ...
                                        <tr>
                                            <td height="75" valign="top">
                                                <asp:Image ID="Image129" runat="server" ImageUrl="~/Staff/Images/LeftArrow.png" />
                                            </td>
                                            <td valign="top">
                                        ...
                                        <tr>
                                            <td height="75" valign="top">
                                                <asp:Image ID="Image130" runat="server" ImageUrl="~/Staff/Images/LeftArrow.png" />
                                            </td>
                                            <td valign="top">
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="4" height="28">
                                                <asp:GridView ID="GridViewStudents0" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSourceGridviewStudents0"
                                                    Width="98%">
                                                    <Columns>
                            ...
                            <asp:SqlDataSource ID="SqlDataSourceGridviewStudents0" runat="server" ConnectionString="<%$ ConnectionStrings:SMSOnlineConnectionString %>"
                ...
                <asp:SqlDataSource ID="SqlDataSourceListBoxParents" runat="server" ConnectionString="<%$ ConnectionStrings:SMSOnlineConnectionString %>"
                    SelectCommand="SELECT ResponsibleParentID, ResponsibleParent, SectionCatalogID, AcademicTermID, SchoolCode, SectionSchool FROM vw_Parents WHERE (SchoolCode = @SchoolCode) AND (SectionSchool = @IsSD OR SectionSchool = @IsSMP OR SectionSchool = @IsSMA) AND (AcademicTermID = @AcademicTermID) ORDER BY ResponsibleParent"
                    FilterExpression="SectionCatalogID={1}">
                    <FilterParameters>
                ...
                <uc2:UCWebMessageBox ID="UCWebMessageBoxParents" runat="server" />
                <br />
