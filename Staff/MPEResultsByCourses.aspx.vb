...
Partial Class Assignments
    ...
    Sub Item_DataBound(ByVal sender As Object, ByVal e As DataListItemEventArgs)
        ...
        Catch ex As Exception
            WebMessageBoxExams.Show("An error occured:" & ex.Message, "Error")
        End Try
    End Sub
    ...
    Protected Sub ButtonFilter_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButtonFilter.Click
        Try
            ...
            SqlString = "SELECT GeneralTestID, GeneralTestName, SectionCatalog, StudentID, StudentName, Correct, Wrong, NotAnswered, Score, CourseCategory, SchoolCode, CurrentSectionID, AcademicTermID FROM vw_GeneralTestsScoresCalculated "
            ...
            Else
                ...
                SqlString += "Where SchoolCode=@SchoolCode And GeneralTestGroupID=@GeneralTestGroupID And CourseCategory=@CourseCategory And AcademicTermID=@AcademicTermID And (" & SqlStringFilter & ") Order By StudentName"

                SqlDataSourceGeneralTestsScores.SelectCommand = SqlString

                SqlDataSourceGeneralTestsScores.SelectParameters.Clear()
                SqlDataSourceGeneralTestsScores.SelectParameters.Add(New Parameter("AcademicTermID", Data.DbType.Int32, DropDownListAcademicTermsMaster.SelectedValue))
                ...
                SqlDataSourceGeneralTestsScoresPrint.SelectParameters.Add(New Parameter("AcademicTermID", Data.DbType.Int32, DropDownListAcademicTermsMaster.SelectedValue))
