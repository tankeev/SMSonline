    ...
    <asp:UpdatePanel ID="UpdatePanel" runat="server">
        <ContentTemplate>
            <div class="content-left">
                ...
                <br />
                <div id="divPanels">
                    <asp:Panel ID="PanelInfoUsersSearch" runat="server" CssClass="MenuToolTip" Width="230">
                    ...
                    <asp:Panel ID="PanelInfoList" runat="server" CssClass="MenuToolTip" Width="230">
                        <asp:Label ID="Label6" runat="server" Text="Classroom Lists" ForeColor="Red" Font-Bold="True"></asp:Label>
                        <br />
                        <br />
                        <asp:Label ID="Label7" runat="server" Text="Click here to see Classroom Lists."></asp:Label>
                        <img class="callout" src="images/callout.gif" />
                    </asp:Panel>
                </div>
            </div>
            <div class="content-right">
                <h2>
                    STUDENT LIST</h2>
                <br />
                <table width="680" class="content-table">
                    <tr>
                        <td height="50">
