        ...
        <ContentTemplate>
            <div class="content-left">
                <h2>
                    MENU</h2>
                <br />
                <uc1:MenuAttendance ID="MenuAttendance" runat="server" />
                <br />
            ...
            <div class="content-right">
                ...
                <asp:SqlDataSource ID="SqlDataSourceSections" runat="server" ConnectionString="<%$ ConnectionStrings:SMSOnlineConnectionString %>"
                    SelectCommand="SELECT DISTINCT SectionCatalogID, SectionCatalog, SectionGroup FROM vw_CourseSections WHERE (AcademicTermID = @AcademicTermID) AND (SchoolCode = @SchoolCode) AND (StaffID = @StaffID) ORDER BY SectionGroup">
                    <SelectParameters>
                ...
                <asp:SqlDataSource ID="SqlDataSourceStudents" runat="server" ConnectionString="<%$ ConnectionStrings:SMSOnlineConnectionString %>"
                    SelectCommand="SELECT SchoolCode, SectionCatalogID, AcademicTermID, StudentID, StudentName, Date, [1], [2], [3], [4], [5], [6], [7], [8], [9] FROM vw_Attendance WHERE (Date = @Date) AND (SchoolCode = @SchoolCode) AND (SectionCatalogID = @SectionCatalogID) AND (AcademicTermID = @AcademicTermID)"
...
INSERT INTO tbl_Attendance(AcademicTermID, SchoolCode, AttendanceTypeID, StudentID, Date, Period, SavedOn, SavedAt, SavedBy) VALUES (@AcademicTermID, @SchoolCode, @AttendanceTypeID, @StudentID, @Date, @Period, @SavedOn, @SavedAt, @SavedBy)">
                ...
                <uc2:WebMessageBox ID="WebMessageBoxAttendance" runat="server" />
            </div>
        </ContentTemplate>
    </asp:UpdatePanel>
</asp:Content>
