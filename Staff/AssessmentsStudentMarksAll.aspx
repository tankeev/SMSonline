        ...
        <ContentTemplate>
            <div class="content-left">
                ...
                <table class="content-table" width="240">
                    ...
                    <tr>
                        <td width="40">
                            <asp:HyperLink ID="HyperLinkView0" runat="server" ImageUrl="~/Staff/Images/menu_view.png"
                ...
                <table class="content-table" width="240">
                    ...
                    <tr>
                        <td width="40">
                            <asp:HyperLink ID="HyperLinkMPExams" runat="server" ImageUrl="~/Staff/Images/menu_courses.png"
                                NavigateUrl="~/Staff/AssessmentsMPExams.aspx"></asp:HyperLink>
                        </td>
                        <td>
                            <asp:Label ID="Label148" runat="server" Text="MP Exams Course Scores"></asp:Label>
                        </td>
                    </tr>
                </table>
            </div>
            <div class="content-right">
                ...
                <table style="border: 1px solid #CCCCCC; background-color: #FFFF99;" width="680">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:Label ID="Label143" runat="server" Font-Size="X-Small" Text="Quiz"></asp:Label>
                        </td>
                        <td width="25">
                        ...
                        <td>
                            <asp:Label ID="Label1" runat="server" Font-Bold="True" ForeColor="Maroon" Text="(H) "></asp:Label>
                ...
                <asp:GridView ID="GridViewStudents" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSourceAssessmentsStudents"
                    Width="680px" ShowHeader="False" AllowPaging="True" PageSize="5">
                    <Columns>
                ...
                <br />
                <asp:Button ID="ButtonUpdate" runat="server" Text="Update All Assessment Marks" Width="680px" />
                ...
                <uc2:UCWebMessageBox ID="WebMessageBoxMarksAll" runat="server" />
            </div>
        </ContentTemplate>
    </asp:UpdatePanel>
</asp:Content>
