...
Partial Class Skills_Comments
    ...
    Protected Sub GridViewSections_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GridViewSections.RowDataBound
        If GridViewSections.Rows.Count > 0 Then
            GridViewSections.SelectedIndex = 0
    ...
    Protected Sub GridViewSections_DataBound(ByVal sender As Object, ByVal e As System.EventArgs) Handles GridViewSections.DataBound
        Try
