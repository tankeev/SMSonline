        ...
        <ContentTemplate>
            <div class="content-left">
                ...
                <table class="content-table" width="240">
                    ...
                    <tr>
                        <td height="28">
                            <asp:Label ID="Label34" runat="server" Font-Bold="True" Text="School Sections" ForeColor="Red"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>
            ...
            <div class="content-right">
                ...
                <asp:GridView ID="GridViewAssessmentsMarks" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                    Font-Names="Arial" Font-Size="9pt" Width="675px" DataSourceID="SqlDataSourceGridViewAssessments"
                    PageSize="18">
                    <Columns>
                ...
                <uc2:UCWebMessageBox ID="WebMessageBoxStudents" runat="server" />
            </div>
        </ContentTemplate>
        <Triggers>
