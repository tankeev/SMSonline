                        ...
                        <asp:TabPanel ID="TabPanel1" runat="server" HeaderText="TabPanel1">
                            ...
                            <ContentTemplate>
                                ...
                                <asp:GridView ID="GridViewGeneralTestsScores" runat="server" AutoGenerateColumns="False"
                                    OnRowCommand="GridViewGeneralTestsScores_RowCommand" Width="650px">
                                    <Columns>
                                        <asp:TemplateField>
                                            <ItemTemplate>
...
ORDER BY GeneralTestQuestionNo">
                        ...
                        <asp:TabPanel ID="TabPanel2" runat="server" HeaderText="TabPanel2">
                            ...
                            <ContentTemplate>
                                <asp:UpdatePanel ID="UpdatePanelPrinter" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <table width="650">
                                            <tr>
                                                <td>
                                                    <asp:Label ID="Label24" runat="server" Font-Bold="True" ForeColor="Red" Text="PRINTING SECTION : Use the buttons to Print the following Table"></asp:Label>
                                                </td>
                                                <td width="40">
                ...
                <uc2:WebMessageBox ID="WebMessageBoxExams" runat="server" />
            </div>
        </ContentTemplate>
    </asp:UpdatePanel>
</asp:Content>
