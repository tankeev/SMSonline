        ...
        <ContentTemplate>
            <div class="content-left">
                ...
                <table class="content-table" width="240">
                    <tr>
                        <td height="30">
                            <asp:Label ID="Label178" runat="server" Font-Bold="True" Text="Select Academic Term"
                    ...
                    <tr>
                        <td height="30">
                            <asp:Label ID="Label134" runat="server" Font-Bold="True" ForeColor="Red" Text="Select a Course Please"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>
            ...
            <div class="content-right">
                ...
                <asp:GridView ID="GridViewStudents" runat="server" AutoGenerateColumns="False" Width="675px"
                    DataSourceID="SqlDataSourceAssessmentsMidTermStudents">
                    <Columns>
          ...
          <asp:TextBox ID="TextBoxAverage" runat="server" MaxLength="3" Width="25px" Visible="False"
                ...
                <br />
                <asp:Panel ID="PanelInput" runat="server" Visible="False" Width="680px">
                ...
                <asp:SqlDataSource ID="SqlDataSourceCourses" runat="server" ConnectionString="<%$ ConnectionStrings:SMSOnlineConnectionString %>"
                    ...
                    SelectCommand="SELECT CourseSectionID, CourseCatalogID, SectionCatalogID, CourseGroupingID, SectionCatalog + N' ' + CourseCategory AS CourseCategory FROM vw_CourseSections WHERE (StaffID = @StaffID) AND (AcademicTermID = @AcademicTermID) AND (IsAcademic = 1) AND (CourseGroupingIsChild = 0) ORDER BY SectionGroup, CourseCategory">
                    <SelectParameters>
                ...
                <asp:SqlDataSource ID="SqlDataSourceAssessmentsMidTermStudents" runat="server" ConnectionString="<%$ ConnectionStrings:SMSOnlineConnectionString %>"
                    ...
                    SelectCommand="SELECT StudentID, StudentName, CourseCategory, Exam, Quiz, Homework, Evaluation, Knowledge, Practice FROM vw_AssessmentMarksAverageofTypesMidTermPivot WHERE (AcademicTermID = @AcademicTermID) AND (SectionCatalogID = @SectionCatalogID) AND (CourseCatalogID = @CourseCatalogID) AND (SchoolCode = @SchoolCode) ORDER BY StudentName">
                    <SelectParameters>
                        <asp:ControlParameter ControlID="GridViewAcademicTerms" Name="AcademicTermID" PropertyName="SelectedValue" />
                ...
                <asp:SqlDataSource ID="SqlDataSourceReportMidTermAverages" runat="server" ConnectionString="<%$ ConnectionStrings:SMSOnlineConnectionString %>"
                    ...
                    InsertCommand="UPDATE tbl_ReportAverages SET Average = @Average, AddedBy = @AddedBy, AddedDate = @AddedDate, Practice = @Practice WHERE (StudentID = @StudentID) AND (CourseCatalogID = @CourseCatalogID) AND (AcademicTermID = @AcademicTermID)
