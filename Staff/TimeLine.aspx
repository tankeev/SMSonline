<%@ Page Title="SIS Timeline" Language="VB" MasterPageFile="~/Site.Master" CodeFile="TimeLine.aspx.vb"
    EnableEventValidation="false" Inherits="Timeline" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel" runat="server">
        <ContentTemplate>
            <div class="content-left">
                ...
                <br />
                <asp:Panel ID="PanelGroupUsers" runat="server" Width="230" Visible="False">
                    <table id="TableGroupUsers" class="content-table" width="240">
                        <tr>
                            <td height="28">
            ...
            <div class="content-right">
                <h2>
                    DASHBOARD</h2>
                <br />
                <table width="680" style="border: 1px solid #CCCCCC; background-color: #FFFFE1">
                    <tr>
                        <td height="30">
                    ...
                    <tr>
                        <td height="20">
                            <asp:RequiredFieldValidator ID="RequiredFieldValidatorTopic" runat="server" ControlToValidate="MessageTextBoxTopic"
                                ErrorMessage="* Please write something..." Font-Bold="True" ForeColor="Red" ValidationGroup="TimelineTopic"
                                Font-Size="X-Small">* Please write something first...</asp:RequiredFieldValidator>
                        </td>
                        <td width="50">
                            &nbsp;
                        </td>
                    ...
                    <tr>
                        <td height="20">
                            <asp:RegularExpressionValidator ID="RegularExpressionValidatorTimeline" runat="server"
                                ControlToValidate="MessageTextBoxTopic" ErrorMessage="* Please Check Your Message! (Invalid Characters)"
                                Font-Bold="True" Font-Size="X-Small" ForeColor="Red" ValidationExpression="^([a-zA-Z0-9.]|-|\s)+$"
                                ValidationGroup="TimelineTopic">* Please Check Your Message! (Invalid Characters)</asp:RegularExpressionValidator>
                        </td>
                        <td width="50">
                            &nbsp;
                        </td>
                                ...
                                <table width="100%">
                                    <tr>
                                        <td height="25" width="25" align="center">
                                            <asp:Image ID="Image2" runat="server" ImageUrl="~/Staff/Images/row.gif" />
                                        </td>
                                        <td height="25">
