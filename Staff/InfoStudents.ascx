<%@ Control Language="VB" AutoEventWireup="false" CodeFile="InfoStudents.ascx.vb"
    Inherits="Staff_InfoStudents" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<asp:ModalPopupExtender ID="ModalPopupExtenderStudentInfo" runat="server" TargetControlID="btnStudentInfo"
    PopupControlID="PanelStudentInfo" BackgroundCssClass="modalBackground" DropShadow="true"
    CancelControlID="ButtonCloseStudentInfo">
</asp:ModalPopupExtender>
<asp:Panel ID="PanelStudentInfo" runat="server" CssClass="modalPopup" Width="650px">
    <asp:ImageButton ID="ButtonCloseStudentInfo" runat="server" CssClass="CloseButton"
        ImageUrl="~/Staff/Images/Message_Error.png" />
    <br />
    <asp:HiddenField ID="HiddenFieldSelectedStudentID" runat="server" />
    <asp:UpdatePanel ID="UpdatePanelTabContainer" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:TabContainer ID="TabContainerStudents" runat="server" ActiveTabIndex="0" Width="98%"
                CssClass="tab" AutoPostBack="True">
                <asp:TabPanel ID="TabPanelBasic" runat="server" HeaderText="Student Information">
                    <HeaderTemplate>
                        Overview
                    </HeaderTemplate>
                    <ContentTemplate>
                        <asp:UpdatePanel ID="UpdatePaneBasicInformation" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                        ...
                                        <table id="tblBasicInformation" width="100%">
                                            <tr>
                                                <td height="30" width="20">
                                                    <asp:Image ID="Image1" runat="server" ImageUrl="~/Staff/Images/LeftArrow.png" />
                                                </td>
                                                <td width="140">
                                            ...
                                            <tr>
                                                <td height="30">
                                                    <asp:Image ID="Image11" runat="server" ImageUrl="~/Staff/Images/LeftArrow.png" />
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="TextBoxStudentName" runat="server" MaxLength="50" Text='<%# Bind("StudentName") %>'
                                            ...
                                            <tr>
                                                <td height="30">
                                                    <asp:Image ID="Image3" runat="server" ImageUrl="~/Staff/Images/LeftArrow.png" />
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td height="30">
                                                    <asp:Image ID="Image6" runat="server" ImageUrl="~/Staff/Images/LeftArrow.png" />
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td height="30">
                                                    <asp:Image ID="Image10" runat="server" ImageUrl="~/Staff/Images/LeftArrow.png" />
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td height="30">
                                                    <asp:Image ID="Image33" runat="server" ImageUrl="~/Staff/Images/LeftArrow.png" />
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td height="30">
                                                    <asp:Image ID="Image34" runat="server" ImageUrl="~/Staff/Images/LeftArrow.png" />
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td height="30">
                                                    <asp:Image ID="Image16" runat="server" ImageUrl="~/Staff/Images/LeftArrow.png" />
                                                </td>
                                                <td>
                                    ...
                                    <EmptyDataTemplate>
                                        <div align="center">
                                            ...
                                            <asp:Label ID="LabelWarning" runat="server" Font-Bold="True" Font-Size="Medium" ForeColor="Red"
                                                Text="Please Select a Student from the Menu on the Left to Load Data!"></asp:Label>
                                            <br />
                                            <br />
                                        </div>
                                    </EmptyDataTemplate>
                                ...
                                <asp:SqlDataSource ID="SqlDataSourceFormViewStudentsBasicInformation" runat="server"
                                    ConnectionString="<%$ ConnectionStrings:SMSOnlineConnectionString %>" SelectCommand="SELECT StudentID, SchoolNo, StudentName, DateofBirth, BirthPlace, Gender, IsOlympiad, OlympiadName, CurrentSectionID, Religion, IsScholarship, ScholarshipPercentage FROM tbl_Students WHERE (StudentID = @StudentID)"
                        ...
                        <asp:FormView ID="FormViewStudentsAdditionalInformation" runat="server" DataKeyNames="StudentID"
                            ...
                            <EditItemTemplate>
                                <table id="tblAdditionalInformation" width="100%">
                                    <tr>
                                        <td height="30" width="20">
                                            <asp:Image ID="Image91" runat="server" ImageUrl="~/Staff/Images/LeftArrow.png" />
                                        </td>
                                        <td width="140">
                                    ...
                                    <tr>
                                        <td height="30" width="20">
                                            <asp:Image ID="Image92" runat="server" ImageUrl="~/Staff/Images/LeftArrow.png" />
                                        </td>
                                        <td width="120">
                                    ...
                                    <tr>
                                        <td height="30" width="20">
                                            <asp:Image ID="Image93" runat="server" ImageUrl="~/Staff/Images/LeftArrow.png" />
                                        </td>
                                        <td width="120">
                                    ...
                                    <tr>
                                        <td height="30" width="20">
                                            <asp:Image ID="Image94" runat="server" ImageUrl="~/Staff/Images/LeftArrow.png" />
                                        </td>
                                        <td width="120">
                                    ...
                                    <tr>
                                        <td height="30" width="20">
                                            <asp:Image ID="Image95" runat="server" ImageUrl="~/Staff/Images/LeftArrow.png" />
                                        </td>
                                        <td width="120">
                                    ...
                                    <tr>
                                        <td valign="top" width="20">
                                            <asp:Image ID="Image126" runat="server" ImageUrl="~/Staff/Images/LeftArrow.png" />
                                        </td>
                                    ...
                                    <tr>
                                        <td height="28" valign="top" width="20">
                                            <asp:Image ID="Image127" runat="server" ImageUrl="~/Staff/Images/LeftArrow.png" />
                                        </td>
                                        <td valign="top" width="120">
                        ...
                        <asp:FormView ID="FormViewStudentsEnrollmentDetails" runat="server" DataKeyNames="StudentID"
                            ...
                            <EditItemTemplate>
                                <table id="tblEnrollmentDetails0" width="100%">
                                    <tr>
                                        <td height="30" width="20">
                                            <asp:Image ID="Image66" runat="server" ImageUrl="~/Staff/Images/LeftArrow.png" />
                                        </td>
                                        <td width="140">
                                    ...
                                    <tr>
                                        <td height="30">
                                            <asp:Image ID="Image67" runat="server" ImageUrl="~/Staff/Images/LeftArrow.png" />
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td height="30">
                                            <asp:Image ID="Image68" runat="server" ImageUrl="~/Staff/Images/LeftArrow.png" />
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td height="30">
                                            <asp:Image ID="Image81" runat="server" ImageUrl="~/Staff/Images/LeftArrow.png" />
                                        </td>
                                        <td height="25">
                                    ...
                                    <tr>
                                        <td height="30">
                                            <asp:Image ID="Image82" runat="server" ImageUrl="~/Staff/Images/LeftArrow.png" />
                                        </td>
                                        <td height="25">
                                    ...
                                    <tr>
                                        <td height="75" valign="top">
                                            <asp:Image ID="Image71" runat="server" ImageUrl="~/Staff/Images/LeftArrow.png" />
                                        </td>
                                    ...
                                    <tr>
                                        <td height="25" valign="top">
                                            <asp:Image ID="Image72" runat="server" ImageUrl="~/Staff/Images/LeftArrow.png" />
                                        </td>
                                        <td height="75" valign="top">
                        ...
                        <asp:FormView ID="FormViewParentsGuardianDetails" runat="server" DataSourceID="SqlDataSourceFormViewParentsGuardiansDetails"
                            ...
                            <EditItemTemplate>
                                <table id="tblGuardiansDetails0" width="100%">
                                    <tr>
                                        <td height="30" width="20">
                                            <asp:Image ID="Image96" runat="server" ImageUrl="~/Staff/Images/LeftArrow.png" />
                                        </td>
                                        <td width="130">
                                            <asp:Label ID="Label58" runat="server" meta:resourceKey="Label2Resource1" Text="Guardian's Name:"
                                                Font-Bold="True"></asp:Label>
                                        </td>
                                        <td width="180">
                                        ...
                                        <td width="20">
                                            <asp:Image ID="Image124" runat="server" ImageUrl="~/Staff/Images/LeftArrow.png" />
                                        </td>
                                        <td width="130">
                                            <asp:Label ID="Label59" runat="server" meta:resourceKey="Label2Resource1" Text="Contact Phone:"
                                                Font-Bold="True"></asp:Label>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td height="30">
                                            <asp:Image ID="Image97" runat="server" ImageUrl="~/Staff/Images/LeftArrow.png" />
                                        </td>
                                        <td>
                                            <asp:Label ID="Label60" runat="server" meta:resourceKey="Label2Resource1" Text="Current City:"
                                                Font-Bold="True"></asp:Label>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <asp:Image ID="Image125" runat="server" ImageUrl="~/Staff/Images/LeftArrow.png" />
                                        </td>
                                        <td>
                                            <asp:Label ID="Label61" runat="server" meta:resourceKey="Label2Resource1" Text="Contact Email:"
                                                Font-Bold="True"></asp:Label>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td height="75" valign="top">
                                            <asp:Image ID="Image99" runat="server" ImageUrl="~/Staff/Images/LeftArrow.png" />
                                        </td>
                                        <td valign="top">
                                            <asp:Label ID="Label62" runat="server" meta:resourceKey="Label5Resource1" Text="Contact Address:"
                                                Font-Bold="True"></asp:Label>
                                        </td>
                                    ...
                                    <tr>
                                        <td height="30">
                                            <asp:Image ID="Image46" runat="server" ImageUrl="~/Staff/Images/LeftArrow.png" />
                                        </td>
                                        <td>
                                            <asp:Label ID="Label25" runat="server" meta:resourceKey="Label5Resource1" Text="Known Languages:"
                                                Font-Bold="True"></asp:Label>
                                        </td>
                                        <td colspan="4">
                                    ...
                                    <tr>
                                        <td height="75" valign="top">
                                            <asp:Image ID="Image47" runat="server" ImageUrl="~/Staff/Images/LeftArrow.png" />
                                        </td>
                                        <td valign="top">
                                            <asp:Label ID="LabelStartingTerm2" runat="server" meta:resourceKey="LabelStartingTermResource1"
                                                Text="Home Visits:" Font-Bold="True"></asp:Label>
                                        </td>
                                        <td colspan="4" valign="top">
                                    ...
                                    <tr>
                                        <td height="75" valign="top">
                                            <asp:Image ID="Image49" runat="server" ImageUrl="~/Staff/Images/LeftArrow.png" />
                                        </td>
                                        <td valign="top">
                                            <asp:Label ID="LabelStartingTerm3" runat="server" meta:resourceKey="LabelStartingTermResource1"
                                                Text="Notes:" Font-Bold="True"></asp:Label>
                                        </td>
                                        <td colspan="4">
                        ...
                        <asp:FormView ID="FormViewParentsParentsInformation" runat="server" DataKeyNames="ResponsibleParentID"
                            ...
                            <EditItemTemplate>
                                <table id="StudentTable1" width="100%">
                                    ...
                                    <tr>
                                        <td height="30">
                                            <asp:Image ID="Image105" runat="server" ImageUrl="~/Staff/Images/LeftArrow.png" />
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <asp:Image ID="Image106" runat="server" ImageUrl="~/Staff/Images/LeftArrow.png" />
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td height="30">
                                            <asp:Image ID="Image110" runat="server" ImageUrl="~/Staff/Images/LeftArrow.png" />
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <asp:Image ID="Image109" runat="server" ImageUrl="~/Staff/Images/LeftArrow.png" />
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td height="30">
                                            <asp:Image ID="Image89" runat="server" ImageUrl="~/Staff/Images/LeftArrow.png" />
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <asp:Image ID="Image90" runat="server" ImageUrl="~/Staff/Images/LeftArrow.png" />
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td height="30">
                                            <asp:Image ID="Image103" runat="server" ImageUrl="~/Staff/Images/LeftArrow.png" />
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <asp:Image ID="Image104" runat="server" ImageUrl="~/Staff/Images/LeftArrow.png" />
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td height="30" valign="top">
                                            <asp:Image ID="Image107" runat="server" ImageUrl="~/Staff/Images/LeftArrow.png" />
                                        </td>
                                        <td valign="top">
                                        ...
                                        <td valign="top">
                                            <asp:Image ID="Image108" runat="server" ImageUrl="~/Staff/Images/LeftArrow.png" />
                                        </td>
                                        <td valign="top">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:Image ID="Image98" runat="server" ImageUrl="~/Staff/Images/LeftArrow.png" />
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td height="28">
                                            <asp:Image ID="Image100" runat="server" ImageUrl="~/Staff/Images/LeftArrow.png" />
                                        </td>
