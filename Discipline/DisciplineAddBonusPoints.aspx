            ...
            <div class="content-right">
                ...
                <table width="675">
                    <tr>
                        ...
                        <td width="150">
                            <asp:Label ID="Label176" runat="server" Text="Bonus Type:" Font-Bold="True"></asp:Label>
                        </td>
                        <td>
                            <asp:DropDownList ID="DropDownListDisciplineTypes" runat="server" AppendDataBoundItems="True"
                ...
                <br />
                <asp:Button ID="ButtonAddRecords" runat="server" Text="Add Bonus Card" Width="675px" />
                <br />
                ...
                <asp:SqlDataSource ID="SqlDataSourceDisciplineTypes" runat="server" ConnectionString="<%$ ConnectionStrings:SMSOnlineConnectionString %>"
                    SelectCommand="SELECT DisciplineTypeID, DisciplineType, PointType FROM tbl_DisciplineTypes WHERE (PointType = 1) ORDER BY DisciplineType">
                </asp:SqlDataSource>
