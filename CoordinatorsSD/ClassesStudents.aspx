            ...
            <div class="content-right">
                ...
                <asp:GridView ID="GridViewStudents" runat="server" AutoGenerateColumns="False" DataKeyNames="StudentID"
                    ...
                    <Columns>
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:Image ID="Image2" runat="server" ImageUrl="~/CoordinatorsSD/Images/arrow.gif" />
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Save">
                            <ItemTemplate>
                                <asp:ImageButton ID="ImageButtonSave" runat="server" CommandName="Update" ImageUrl="~/CoordinatorsSD/Images/Save-as-icon.png" />
