        ...
        <ContentTemplate>
                    ...
                    <tr>
                        <td width="40">
                            <asp:HyperLink ID="HyperLinkAddNew" runat="server" ImageUrl="~/Coordinators/Images/menu_add.png"
                                NavigateUrl="~/Coordinators/ParentsAdd.aspx" Enabled="False">Add New</asp:HyperLink>
                        </td>
                        <td>
                            <asp:Label ID="Label23" runat="server" Text="Add New Parent" ForeColor="Red"></asp:Label>
                        </td>
                    </tr>
                </table>
                <br />
            ...
            <div class="content-right">
                <h2>
                    ADD PARENT</h2>
                <br />
                <asp:CreateUserWizard ID="CreateUserWizardParent" runat="server" ContinueDestinationPageUrl="~/CoordinatorsSD/UsersParents.aspx"
