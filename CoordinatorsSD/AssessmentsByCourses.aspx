        ...
        <ContentTemplate>
            <div class="content-left">
                ...
                <table class="content-table" width="240">
                    <tr>
                        <td height="28">
                            <asp:Label ID="Label34" runat="server" Font-Bold="True" Text="Select School Section"
                    ...
                    <tr>
                        <td height="28">
                            <asp:Label ID="Label35" runat="server" Font-Bold="True" Text="Select Section Course"
                                ForeColor="Red"></asp:Label>
                        </td>
                    </tr>
                    <tr>
            ...
            <div class="content-right">
                ...
                <asp:GridView ID="GridViewAssessments" runat="server" AutoGenerateColumns="False"
                    ...
                    <EmptyDataTemplate>
                        <asp:Panel ID="PanelEmpty0" runat="server" HorizontalAlign="Center">
                            <br />
                            <asp:Image ID="ImageEmpty0" runat="server" ImageUrl="~/Staff/Images/warning.png" />
                            <br />
                            <br />
                            <br />
                ...
                <br />
                <asp:Button ID="ButtonUpdate" runat="server" Text="Update All" Width="675px" />
                <asp:ConfirmButtonExtender ID="ButtonUpdate_ConfirmButtonExtender" runat="server"
                    ConfirmText="Do you really want to save?" Enabled="True" TargetControlID="ButtonUpdate">
                ...
                <table width="675" class="content-table">
                    <tr>
                        <td height="50">
                            <asp:Label ID="Label132" runat="server" Font-Bold="True" ForeColor="Red" Text="Assessments Marks"
                ...
                <asp:GridView ID="GridViewAssessmentsMarks" runat="server" AutoGenerateColumns="False"
                    DataSourceID="SqlDataSourceAssessmentsMarks" Font-Names="Arial" Font-Size="9pt"
                    Width="675px">
                    <Columns>
                    ...
                    <EmptyDataTemplate>
                        <asp:Panel ID="PanelEmpty1" runat="server" HorizontalAlign="Center">
                            <br />
                            <asp:Image ID="ImageEmpty1" runat="server" ImageUrl="~/Coordinators/Images/warning.png" />
                            <br />
                            <br />
                            <br />
                ...
                <asp:SqlDataSource ID="SqlDataSourceCourseSectionAssessmentTypes" runat="server"
                    ConnectionString="<%$ ConnectionStrings:SMSOnlineConnectionString %>" SelectCommand="SELECT CourseSectionAssessmentTypeID, CourseCategory + N' ' + Description + N' ' + AcademicTerm AS CourseSectionAssessmentType FROM vw_CourseSectionAssessmentTypes WHERE (SectionCatalogID = @SectionCatalogID) AND (SchoolCode = @SchoolCode) AND (CourseCategory = @CourseCategory) ORDER BY CourseSectionAssessmentType">
                    <SelectParameters>
                        <asp:ControlParameter ControlID="DropDownListSections" Name="SectionCatalogID" PropertyName="SelectedValue" />
                        <asp:ControlParameter ControlID="DropDownListSchoolCodesMaster" Name="SchoolCode"
                            PropertyName="SelectedValue" />
                        <asp:ControlParameter ControlID="ListBoxCourses" Name="CourseCategory" PropertyName="SelectedItem.Text" />
                    </SelectParameters>
                </asp:SqlDataSource>
                <uc2:WebMessageBox ID="WebMessageBoxCourses" runat="server" />
            </div>
        </ContentTemplate>
        <Triggers>
