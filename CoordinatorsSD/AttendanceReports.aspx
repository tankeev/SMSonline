        ...
        <ContentTemplate>
            <div class="content-left">
                    ...
                    <tr>
                        <td width="40">
                            <asp:HyperLink ID="HyperLinkView" runat="server" ImageUrl="~/Staff/Images/menu_view.png"
                                NavigateUrl="~/CoordinatorsSD/AttendanceTotal.aspx"></asp:HyperLink>
                        </td>
                        <td>
                ...
                <table class="content-table" width="240">
                    <tr>
                        <td height="28">
                            <asp:Label ID="Label42" runat="server" Font-Bold="True" Text="Select Starting Date"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td height="28">
                    ...
                    <tr>
                        <td height="28">
                            <asp:Label ID="Label127" runat="server" Font-Bold="True" Text="Select Finish Date"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td height="28">
            ...
            <div class="content-right">
                ...
                <asp:GridView ID="GridViewAttendanceTypes" runat="server" AutoGenerateColumns="False"
                    DataKeyNames="AttendanceTypeID" 
                    DataSourceID="SqlDataSourceAttendanceTypes" Visible="False"
                    Width="675px">
                    <Columns>
