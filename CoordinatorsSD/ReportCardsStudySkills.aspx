        ...
        <ContentTemplate>
            <div class="content-left">
                ...
                <table class="content-table" width="240">
                    ...
                    <tr>
                        <td height="28">
                            <asp:Label ID="Label134" runat="server" Font-Bold="True" Text="Select Sections" ForeColor="Red"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td height="250">
                            <div style='overflow: auto; height: 100%;'>
                                <asp:GridView ID="GridViewCourseSections" runat="server" AutoGenerateColumns="False"
                                    ...
                                    DataKeyNames="SectionCatalogID" DataSourceID="SqlDataSourceSectionsCourses" ShowHeader="False"
                                    Width="95%">
                                    <Columns>
                                        <asp:TemplateField ShowHeader="False">
                                            <ItemTemplate>
                                                    ...
                                                    <asp:FormView ID="FormViewStudySkills" runat="server" DataSourceID="SqlDataSourceStudySkillsStudents"
                                                        ...
                                                        <EditItemTemplate>
                                                            ...
                                                            <asp:SqlDataSource ID="SqlDataSourceStudySkillsEdit" runat="server" ConnectionString="<%$ ConnectionStrings:SMSOnlineConnectionString %>"
                                                                SelectCommand="SELECT tbl_StudySkillsStudents.ID, tbl_StudySkillsStudents.StudySkillID, tbl_StudySkills.StudySkill, tbl_StudySkillsStudents.Response, tbl_StudySkillsStudents.AcademicSemesterID, tbl_StudySkillsStudents.ReportTypeID, tbl_StudySkillsStudents.StudentID FROM tbl_StudySkillsStudents INNER JOIN tbl_StudySkills ON tbl_StudySkillsStudents.StudySkillID = tbl_StudySkills.StudySkillID WHERE (tbl_StudySkillsStudents.ReportTypeID = @ReportTypeID) AND (tbl_StudySkillsStudents.StudentID = @StudentID) AND (tbl_StudySkillsStudents.AcademicSemesterID = @AcademicSemesterID)"
                                                                ...
                                                                <tr>
                                                                    <td colspan="2" valign="top" height="100">
                                                                        ...
                                                                        <asp:SqlDataSource ID="SqlDataSourceStudySkillsInsert" runat="server" ConnectionString="<%$ ConnectionStrings:SMSOnlineConnectionString %>"
                                                                            InsertCommand="UPDATE tbl_StudySkillsStudents SET Response = @Response WHERE (StudentID = @StudentID) AND (ReportTypeID = @ReportTypeID) AND (StudySkillID = @StudySkillID) AND (AcademicSemesterID = @AcademicSemesterID)
...
INSERT INTO tbl_StudySkillsStudents(StudySkillID, AcademicTermID, ReportTypeID, StudentID, Response, AcademicSemesterID) VALUES (@StudySkillID, @AcademicTermID, @ReportTypeID, @StudentID, @Response, @AcademicSemesterID)"
                                                                            SelectCommand="SELECT ID, StudySkillID, AcademicTermID, ReportTypeID, StudentID, Response FROM tbl_StudySkillsStudents">
                                                                            <InsertParameters>
                                                                                <asp:Parameter Name="Response" />
                                ...
                                <asp:SqlDataSource ID="SqlDataSourceStudySkillsStudents" runat="server" ConnectionString="<%$ ConnectionStrings:SMSOnlineConnectionString %>"
                                    SelectCommand="SELECT StudySkillID, Response, AcademicSemesterID, ReportTypeID, StudentID FROM tbl_StudySkillsStudents WHERE (ReportTypeID = @ReportTypeID) AND (StudentID = @StudentID) AND (AcademicSemesterID = @AcademicSemesterID)">
                                    <SelectParameters>
                                        <asp:ControlParameter ControlID="RadioButtonListReportTypes" Name="ReportTypeID"
                                            PropertyName="SelectedValue" />
                                        <asp:ControlParameter ControlID="HiddenFieldStudentID" Name="StudentID" PropertyName="Value" />
                    ...
                    <EmptyDataTemplate>
                        <div align="center">
                            ...
                            <br />
                            <br />
                            <asp:Label ID="LabelStatus0" runat="server" Font-Bold="True" Font-Size="Medium" ForeColor="Red">Please Select a School Section to See Student List!</asp:Label>
                            <br />
                            <br />
                        </div>
                    </EmptyDataTemplate>
                ...
                <asp:SqlDataSource ID="SqlDataSourceSectionsCourses" runat="server" ConnectionString="<%$ ConnectionStrings:SMSOnlineConnectionString %>"
                    SelectCommand="SELECT DISTINCT tbl_SectionMentors.SectionCatalogID, tbl_SectionCatalog.SectionCatalog, tbl_SectionCatalog.SectionGroup FROM tbl_SectionMentors INNER JOIN tbl_SectionCatalog ON tbl_SectionMentors.SectionCatalogID = tbl_SectionCatalog.SectionCatalogID WHERE (tbl_SectionMentors.IsDefault = 1) AND (tbl_SectionMentors.SchoolCode = @SchoolCode) AND (tbl_SectionMentors.AcademicSemesterID = @AcademicSemesterID) AND (tbl_SectionCatalog.SectionSchool = N'SD') ORDER BY tbl_SectionCatalog.SectionGroup">
                    <SelectParameters>
