        ...
        <ContentTemplate>
            <div class="content-left">
                ...
                <table class="content-table" width="240">
                    <tr>
                        <td width="40">
                            <asp:HyperLink ID="HyperLinkStaffAdd" runat="server" ImageUrl="~/Coordinators/Images/menu_add.png"
                                NavigateUrl="~/Coordinators/UsersStaffAdd.aspx" ToolTip="Add New Staff"></asp:HyperLink>
                        </td>
                        <td>
                            ...
                            <asp:FormView ID="FormViewStaffOverview" runat="server" DataKeyNames="StaffID" DataSourceID="SqlDataSourceFormViewStaffOverview"
                                ...
                                <EditItemTemplate>
                                    <table id="StudentTable" width="100%">
                                        ...
                                        <tr>
                                            <td height="30" width="20">
                                                <asp:Image ID="Image51" runat="server" ImageUrl="~/CoordinatorsSD/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image48" runat="server" ImageUrl="~/CoordinatorsSD/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                            ...
                            <asp:FormView ID="FormViewStaffAdditional" runat="server" DataKeyNames="StaffID"
                                ...
                                <EditItemTemplate>
                                    <table id="StudentTable0" width="100%">
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image73" runat="server" ImageUrl="~/CoordinatorsSD/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image74" runat="server" ImageUrl="~/CoordinatorsSD/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image75" runat="server" ImageUrl="~/CoordinatorsSD/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                            ...
                            <asp:FormView ID="FormViewStaffAcademic" runat="server" DataKeyNames="StaffID" DataSourceID="SqlDataSourceFormViewStaffAcademic"
                                ...
                                <EditItemTemplate>
                                    <table id="StudentTable1" width="100%">
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image69" runat="server" ImageUrl="~/CoordinatorsSD/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                    ...
                                    <table id="StudentDetails1" width="100%">
                                        ...
                                        <tr>
                                            <td valign="top" height="75">
                                                <asp:Image ID="Image70" runat="server" ImageUrl="~/CoordinatorsSD/Images/LeftArrow.png" />
                                            </td>
                                            <td valign="top">
