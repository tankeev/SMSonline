<%@ Page Title="SIS Registration" Language="VB" MasterPageFile="~/Site.Master" CodeFile="ClassesRegistration.aspx.vb"
    Inherits="UserList" %>
        ...
        <ContentTemplate>
            <div class="content-left">
                ...
                <table class="content-table" width="240">
                    ...
                    <tr>
                        <td height="28">
                            <asp:Label ID="LabelTotalStudents" runat="server" Font-Bold="True" ForeColor="Red"></asp:Label>
                        </td>
                    </tr>
                </table>
                <br />
            ...
            <div class="content-right">
                ...
                <asp:GridView ID="GridViewStudents" runat="server" AutoGenerateColumns="False" DataKeyNames="AcademicTermStudentID"
                    DataSourceID="SqlDataSourceAcademicTermsStudents" Width="100%">
                    <Columns>
                        <asp:TemplateField>
                            <ItemTemplate>
