        ...
        <ContentTemplate>
            <div class="content-left">
                ...
                <table class="content-table" width="240">
                    <tr>
                        <td height="28">
                            <asp:Label ID="Label55" runat="server" Font-Bold="True" Text="Academic Terms"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td height="28">
                    ...
                    <tr>
                        <td height="28">
                            <asp:Label ID="Label56" runat="server" Font-Bold="True" Text="School List"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td height="28">
                ...
                <br />
                <asp:Panel ID="PanelInsertAll" runat="server" CssClass="modalPopup" Width="240px">
                    <table width="100%">
                        <tr>
                            <td height="25">
