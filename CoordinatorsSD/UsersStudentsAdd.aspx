        ...
        <ContentTemplate>
            <div class="content-left">
                ...
                <table class="content-table" width="240">
                    <tr>
                        <td width="40">
                            <asp:HyperLink ID="HyperLinkAddNew" runat="server" ImageUrl="~/CoordinatorsSD/Images/menu_add.png"
                                NavigateUrl="~/CoordinatorsSD/UsersStudentsAdd.aspx" Enabled="False">Add New</asp:HyperLink>
                        </td>
                        <td>
                            <asp:Label ID="Label23" runat="server" Text="Add New Student" ForeColor="Red"></asp:Label>
                        </td>
                    </tr>
                </table>
                <br />
                <table class="content-table" width="240">
                    <tr>
                        <td width="40">
                            <asp:HyperLink ID="HyperLinkCancellation" runat="server" ImageUrl="~/CoordinatorsSD/Images/menu_remove.png"
                                NavigateUrl="~/CoordinatorsSD/UsersStudentsCancel.aspx"></asp:HyperLink>
                        </td>
                        <td>
                            <asp:Label ID="Label27" runat="server" Text="Cancelled Enrollments"></asp:Label>
                        </td>
                    </tr>
                </table>
            </div>
            <div class="content-right">
                ...
                <br />
                <div id="divChild">
                    <asp:CreateUserWizard ID="CreateUserWizardStudent" runat="server" ContinueDestinationPageUrl="~/CoordinatorsSD/UsersStudents.aspx"
                                    ...
                                    <table id="CoordinatorsSDTable" width="100%">
                                        <tr>
                                            ...
                                            <td rowspan="16" valign="top" width="220">
                                                <asp:Image ID="ImageStaff" runat="server" ImageUrl="~/CoordinatorsSD/Images/Students.png"
                                                    Width="220px" />
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:Image ID="Image19" runat="server" ImageUrl="~/CoordinatorsSD/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td height="25">
                                                <asp:Image ID="Image20" runat="server" ImageUrl="~/CoordinatorsSD/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td height="25">
                                                <asp:Image ID="Image21" runat="server" ImageUrl="~/CoordinatorsSD/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="DropDownListSchools" runat="server" DataSourceID="SqlDataSourceSchools"
                                                    DataTextField="SchoolName" DataValueField="SchoolCode" Width="240px" TabIndex="8"
                                                    Enabled="False">
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td height="28">
                                                <asp:Image ID="Image2" runat="server" ImageUrl="~/CoordinatorsSD/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                                <asp:Label ID="Label3" runat="server" Text="Academic Term:"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:DropDownList ID="DropDownListAcademicTermsMaster" runat="server" DataSourceID="SqlDataSourceAcademicTerms"
