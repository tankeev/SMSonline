        ...
        <ContentTemplate>
            <div class="content-left">
                ...
                <table class="content-table" width="240">
                    <tr>
                        <td height="28">
                            <asp:Label ID="Label150" runat="server" Font-Bold="True" Text="Select Semester" ForeColor="Red"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td height="28">
                    ...
                    <tr>
                        <td height="28">
                            <asp:Label ID="Label152" runat="server" Font-Bold="True" ForeColor="Red" Text="Select Report Type"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td height="28">
                    ...
                    <tr>
                        <td height="28">
                            <asp:Label ID="Label151" runat="server" Font-Bold="True" ForeColor="Red" Text="Select Sections"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td height="250">
                            <div style='overflow: auto; height: 100%;'>
                                <asp:GridView ID="GridViewCourseSections" runat="server" AutoGenerateColumns="False"
                                    ...
                                    DataKeyNames="SectionCatalogID,CourseCatalogID" ShowHeader="False" Width="95%"
                                    DataSourceID="SqlDataSourceSectionsCourses">
                                    <Columns>
                                        <asp:TemplateField ShowHeader="False">
                                            <ItemTemplate>
                                                <asp:ImageButton ID="ImageButtonRadio" runat="server" CausesValidation="False" CommandName="Select"
...
INSERT INTO tbl_ReportComments(AcademicTermID, AcademicSemesterID, ReportTypeID, StudentID, Comment, WrittenBy, CourseCatalogID, CourseSectionID) VALUES (@AcademicTermID, @AcademicSemesterID, @ReportTypeID, @StudentID, @Comment, @WrittenBy, @CourseCatalogID, @CourseSectionID)"
                ...
                <asp:SqlDataSource ID="SqlDataSourceSectionsCourses" runat="server" ConnectionString="<%$ ConnectionStrings:SMSOnlineConnectionString %>"
                    SelectCommand="SELECT DISTINCT SectionCatalogID, CourseCatalogID, CourseCategory, SectionCatalog + N' ' + CourseCategory AS CourseSection FROM vw_CourseSections WHERE (SchoolCode = @SchoolCode) AND (SectionSchool = N'SD') AND (AcademicSemesterID = @AcademicSemesterID) ORDER BY CourseSection">
                    <SelectParameters>
