...
<%@ Register Src="EmptyTemplate.ascx" TagName="EmptyTemplate" TagPrefix="uc1" %>
        ...
        <ContentTemplate>
            <div class="content-left">
                ...
                <table class="content-table" width="240">
                    <tr>
                        <td width="40">
                            <asp:HyperLink ID="HyperLinkStudentAdd" runat="server" ImageUrl="~/Coordinators/Images/menu_add.png"
                                NavigateUrl="~/Coordinators/UsersStudentsAdd.aspx" ToolTip="Add New Student"></asp:HyperLink>
                        </td>
                        <td>
                    ...
                    <asp:TabPanel ID="TabPanelBasic" runat="server" HeaderText="Student Information">
                        ...
                        <ContentTemplate>
                            <asp:FormView ID="FormViewStudentsBasicInformation" runat="server" DataSourceID="SqlDataSourceFormViewStudentsBasicInformation"
                                ...
                                <EditItemTemplate>
                                    <table id="tblBasicInformation" width="100%">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Button ID="ButtonUpdate" runat="server" CommandName="Update" Text="Update" Width="240px" />
                                            </td>
                                            <td>
                                                &#160;&#160;
                                            </td>
                                ...
                                <EmptyDataTemplate>
                                    <uc1:EmptyTemplate ID="EmptyTemplate1" runat="server" />
                                </EmptyDataTemplate>
                            </asp:FormView>
                            ...
                            <asp:FormView ID="FormViewParentsParentsInformation" runat="server" DataSourceID="SqlDataSourceFormViewParentsParentsInformation"
                                ...
                                <EditItemTemplate>
                                    <table id="StudentTable1" width="100%">
                                        <tr>
                                            <td height="30" width="20">
                                                <asp:Image ID="Image128" runat="server" ImageUrl="~/CoordinatorsSD/Images/LeftArrow.png" />
                                            </td>
                                            <td width="130">
                                            ...
                                            <td width="20">
                                                <asp:Image ID="Image129" runat="server" ImageUrl="~/CoordinatorsSD/Images/LeftArrow.png" />
                                            </td>
                                            <td width="130">
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image105" runat="server" ImageUrl="~/CoordinatorsSD/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <asp:Image ID="Image106" runat="server" ImageUrl="~/CoordinatorsSD/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Image ID="Image109" runat="server" ImageUrl="~/CoordinatorsSD/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image130" runat="server" ImageUrl="~/CoordinatorsSD/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <asp:Image ID="Image90" runat="server" ImageUrl="~/CoordinatorsSD/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image103" runat="server" ImageUrl="~/CoordinatorsSD/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <asp:Image ID="Image104" runat="server" ImageUrl="~/CoordinatorsSD/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td height="30" valign="top">
                                                <asp:Image ID="Image131" runat="server" ImageUrl="~/CoordinatorsSD/Images/LeftArrow.png" />
                                            </td>
                                            <td valign="top">
                                            ...
                                            <td valign="top">
                                                <asp:Image ID="Image132" runat="server" ImageUrl="~/CoordinatorsSD/Images/LeftArrow.png" />
                                            </td>
                                            <td valign="top">
                                        ...
                                        <tr>
                                            <td height="30" valign="top">
                                                <asp:Image ID="Image107" runat="server" ImageUrl="~/CoordinatorsSD/Images/LeftArrow.png" />
                                            </td>
                                            <td valign="top">
                                            ...
                                            <td valign="top">
                                                <asp:Image ID="Image108" runat="server" ImageUrl="~/CoordinatorsSD/Images/LeftArrow.png" />
                                            </td>
                                            <td valign="top">
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image133" runat="server" ImageUrl="~/CoordinatorsSD/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <asp:Image ID="Image134" runat="server" ImageUrl="~/CoordinatorsSD/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image135" runat="server" ImageUrl="~/CoordinatorsSD/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <asp:Image ID="Image136" runat="server" ImageUrl="~/CoordinatorsSD/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image137" runat="server" ImageUrl="~/CoordinatorsSD/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <asp:Image ID="Image98" runat="server" ImageUrl="~/CoordinatorsSD/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image138" runat="server" ImageUrl="~/CoordinatorsSD/Images/LeftArrow.png" />
                                            </td>
                                            <td height="28">
                                            ...
                                            <td height="28">
                                                <asp:Image ID="Image100" runat="server" ImageUrl="~/CoordinatorsSD/Images/LeftArrow.png" />
                                            </td>
