...
Partial Class Assignments
    ...
    Protected Sub GridViewAssessments_RowUpdating(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewUpdateEventArgs) Handles GridViewAssessments.RowUpdating
        ...
        Dim DropDownListCourseSectionAssessmentTypes As DropDownList = DirectCast(GridViewAssessmentsRow.FindControl("DropDownListCourseSectionAssessmentTypes"), DropDownList)

        e.NewValues("CourseSectionAssessmentTypeID") = DropDownListCourseSectionAssessmentTypes.SelectedValue
