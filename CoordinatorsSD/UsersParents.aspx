...
<%@ Register Src="EmptyTemplate.ascx" TagName="EmptyTemplate" TagPrefix="uc3" %>
        ...
        <ContentTemplate>
            <div class="content-left">
                ...
                <table class="content-table" width="240">
                    <tr>
                        <td width="40">
                            <asp:HyperLink ID="HyperLinkParentAdd" runat="server" ImageUrl="~/Coordinators/Images/menu_add.png"
                                NavigateUrl="~/Coordinators/UsersParentsAdd.aspx" ToolTip="Add New Parent"></asp:HyperLink>
                        </td>
                        <td>
            ...
            <div class="content-right">
                                    ...
                                    <table id="StudentTable0" width="100%">
                                        <tr>
                                            <td height="30" width="20">
                                                <asp:Image ID="Image55" runat="server" ImageUrl="~/CoordinatorsSD/Images/LeftArrow.png" />
                                            </td>
                                            <td width="140">
                                            ...
                                            <td width="240">
                                                <asp:DropDownList ID="DropDownListSchoolCodesMaster" runat="server" DataSourceID="SqlDataSourceFormViewParentsSchoolCodes"
                                                    DataTextField="SchoolName" DataValueField="SchoolCode" SelectedValue='<%# DataBinder.Eval (Container.DataItem, "SchoolCode") %>'
                                                    TabIndex="7" Width="240px">
                                                </asp:DropDownList>
                                            </td>
                                            <td width="20">
                                            </td>
                                        ...
                                        <tr>
                                            <td height="30" width="20">
                                                <asp:Image ID="Image65" runat="server" ImageUrl="~/CoordinatorsSD/Images/LeftArrow.png" />
                                            </td>
                                            <td width="140">
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image57" runat="server" ImageUrl="~/CoordinatorsSD/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image59" runat="server" ImageUrl="~/CoordinatorsSD/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image63" runat="server" ImageUrl="~/CoordinatorsSD/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image64" runat="server" ImageUrl="~/CoordinatorsSD/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td height="75" valign="top">
                                                <asp:Image ID="Image61" runat="server" ImageUrl="~/CoordinatorsSD/Images/LeftArrow.png" />
                                            </td>
                                            <td valign="top">
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image62" runat="server" ImageUrl="~/CoordinatorsSD/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="4">
                                                <asp:Button ID="ButtonUpdateParentsOverview" runat="server" CommandName="Update"
                                                    Text="Update Changes" Width="240px" />
                                            </td>
                                        </tr>
                                    </table>
                                </EditItemTemplate>
                                <EmptyDataTemplate>
                                    <uc3:EmptyTemplate ID="EmptyTemplate1" runat="server" />
                                </EmptyDataTemplate>
                            </asp:FormView>
                            ...
                            <asp:FormView ID="FormViewParentsAdditional" runat="server" DataKeyNames="ResponsibleParentID"
                                ...
                                <EditItemTemplate>
                                    <table id="StudentTable1" width="100%">
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image89" runat="server" ImageUrl="~/CoordinatorsSD/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                ...
                <asp:SqlDataSource ID="SqlDataSourceListBoxParents" runat="server" ConnectionString="<%$ ConnectionStrings:SMSOnlineConnectionString %>"
                    FilterExpression="CurrentSectionID={1}" SelectCommand="SELECT ResponsibleParentID, ResponsibleParent, CurrentSectionID, SchoolCode, SectionSchool FROM vw_Parents WHERE (SchoolCode = @SchoolCode) AND (SectionSchool = @IsSD OR SectionSchool = @IsSMP OR SectionSchool = @IsSMA) ORDER BY ResponsibleParent">
                    <FilterParameters>
