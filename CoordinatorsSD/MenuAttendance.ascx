...
<table class="content-table" width="240">
    ...
    <tr>
        <td width="60" height="50" align="center">
            <asp:HyperLink ID="HyperLinkAttendanceChecklist" runat="server" ImageUrl="~/CoordinatorsSD/Images/menu_attendance_checklist.png"
                NavigateUrl="~/CoordinatorsSD/AttendanceChecklist.aspx"></asp:HyperLink>
        </td>
        <td width="60" align="center">
            <asp:HyperLink ID="HyperLinkAttendanceArchive" runat="server" ImageUrl="~/CoordinatorsSD/Images/menu_attendance_archive.png"
                NavigateUrl="~/CoordinatorsSD/AttendanceArchive.aspx"></asp:HyperLink>
        </td>
        <td width="60" align="center">
            <asp:HyperLink ID="HyperLinkAttendanceReports" runat="server" ImageUrl="~/CoordinatorsSD/Images/menu_attendance_reports.png"
                NavigateUrl="~/CoordinatorsSD/AttendanceReports.aspx"></asp:HyperLink>
        </td>
        <td align="center" width="60">
            <asp:HyperLink ID="HyperLinkAttendanceJournals" runat="server" ImageUrl="~/CoordinatorsSD/Images/menu_attendance_journal.png"
                NavigateUrl="~/CoordinatorsSD/AttendanceJournals.aspx"></asp:HyperLink>
        </td>
    </tr>
</table>
...
<div id="divPanels">
    ...
    <asp:Panel ID="PanelInfoAttendanceArchive" runat="server" Width="240" CssClass="MenuToolTip"
        Style="display: none;">
    ...
    <asp:Panel ID="PanelInfoAttendanceJournals" runat="server" Width="240" CssClass="MenuToolTip"
        Style="display: none;">
