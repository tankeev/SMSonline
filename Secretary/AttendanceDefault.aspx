<%@ Page Title="SIS Attendance Checklist" Language="VB" MasterPageFile="~/Site.Master"
    CodeFile="AttendanceDefault.aspx.vb" Inherits="Attendance_Checklist" %>
        ...
        <ContentTemplate>
            ...
            <div class="content-right">
                ...
                <table bgcolor="#F0F0F0" style="border: 1px solid #999999" width="680">
                    <tr>
                        <td height="35" width="25">
                            <asp:Image ID="Image5" runat="server" ImageUrl="~/Secretary/Images/menu-alt-24.png" />
                        </td>
                    ...
                    <tr>
                        <td height="35">
                            <asp:Image ID="Image6" runat="server" ImageUrl="~/Secretary/Images/menu-alt-24.png" />
                        </td>
                        <td height="35">
                ...
                <asp:Panel ID="PanelEmpty" runat="server" BorderColor="#999999" BorderStyle="Solid"
                    ...
                    <br />
                    <asp:Image ID="ImageEmpty0" runat="server" ImageUrl="~/Secretary/Images/warning.png" />
                    <br />
                    <br />
                    <br />
