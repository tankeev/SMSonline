            ...
            <div class="content-right">
                ...
                <asp:GridView ID="GridViewClassesTeachers" runat="server" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:Image ID="Image2" runat="server" ImageUrl="~/Secretary/Images/Item.png" />
                            </ItemTemplate>
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:ImageButton ID="ImageButton1" runat="server" CommandName="Update" ImageUrl="~/Secretary/Images/save.gif" />
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Center" Width="35px" />
                        </asp:TemplateField>
                    </Columns>
                ...
                <br />
                <asp:Button ID="ButtonUpdateAll" runat="server" Text="Update All Records" Width="680px" />
                <br />
                <br />
                <asp:FormView ID="FormViewClassMentors" runat="server" DataKeyNames="SectionMentorID"
                    DataSourceID="SqlDataSourceClassesTeachers" DefaultMode="Insert" Width="680px">
                    <InsertItemTemplate>
                ...
                <asp:SqlDataSource ID="SqlDataSourceClassesTeachers" runat="server" ConnectionString="<%$ ConnectionStrings:SMSOnlineConnectionString %>"
                    SelectCommand="SELECT tbl_SectionMentors.SectionMentorID, tbl_SectionMentors.AcademicYearID, tbl_SectionMentors.SectionCatalogID, tbl_SectionMentors.StaffID, tbl_SectionCatalog.SectionCatalog, tbl_SectionMentors.SchoolCode, tbl_SectionMentors.IsDefault, tbl_SectionCatalog.SectionGroup FROM tbl_SectionMentors INNER JOIN tbl_SectionCatalog ON tbl_SectionMentors.SectionCatalogID = tbl_SectionCatalog.SectionCatalogID WHERE (tbl_SectionMentors.SchoolCode = @SchoolCode) AND (tbl_SectionMentors.AcademicYearID = @AcademicYearID) ORDER BY tbl_SectionCatalog.SectionGroup, tbl_SectionCatalog.SectionCatalog"
                    ...
                    InsertCommand="INSERT INTO tbl_SectionMentors(AcademicYearID, SchoolCode, SectionCatalogID, StaffID, IsDefault) VALUES (@AcademicYearID, @SchoolCode, @SectionCatalogID, @StaffID, @IsDefault)">
                    <DeleteParameters>
                        <asp:Parameter Name="SectionMentorID" />
                    </DeleteParameters>
                    <InsertParameters>
                        <asp:ControlParameter ControlID="DropDownListAcademicTermsMaster" Name="AcademicYearID"
