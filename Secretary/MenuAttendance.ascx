<%@ Control Language="VB" AutoEventWireup="false" CodeFile="MenuAttendance.ascx.vb"
    Inherits="Secretary_MenuAttendance" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<table class="content-table" width="240">
    <tr>
        <td width="60" height="50" align="center">
            <asp:HyperLink ID="HyperLinkAttendanceChecklist" runat="server" ImageUrl="~/Secretary/Images/menu_attendance_checklist.png"
                NavigateUrl="~/Secretary/AttendanceChecklist.aspx"></asp:HyperLink>
        </td>
        <td width="60" align="center">
            <asp:HyperLink ID="HyperLinkAttendanceArchive" runat="server" ImageUrl="~/Secretary/Images/menu_attendance_archive.png"
                NavigateUrl="~/Secretary/AttendanceArchive.aspx"></asp:HyperLink>
        </td>
        <td width="60" align="center">
            <asp:HyperLink ID="HyperLinkAttendanceReports" runat="server" ImageUrl="~/Secretary/Images/menu_attendance_reports.png"
                NavigateUrl="~/Secretary/AttendanceReports.aspx"></asp:HyperLink>
        </td>
        <td align="center" width="60">
            <asp:HyperLink ID="HyperLinkAttendanceJournals" runat="server" ImageUrl="~/Secretary/Images/menu_attendance_journal.png"
                NavigateUrl="~/Secretary/AttendanceJournals.aspx"></asp:HyperLink>
        </td>
    </tr>
</table>
