    ...
    <asp:UpdatePanel ID="UpdatePanelStudents" runat="server">
        <ContentTemplate>
            <div class="content-left">
                ...
                <br />
                <ucmuc:MenuUsers ID="MenuUsers" runat="server" />
                <br />
                            ...
                            <asp:FormView ID="FormViewStudentsBasicInformation" runat="server" DataSourceID="SqlDataSourceFormViewStudentsBasicInformation"
                                ...
                                <EditItemTemplate>
                                    <table id="tblBasicInformation" width="100%">
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image29" runat="server" ImageUrl="~/Secretary/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image11" runat="server" ImageUrl="~/Secretary/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image3" runat="server" ImageUrl="~/Secretary/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image6" runat="server" ImageUrl="~/Secretary/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image10" runat="server" ImageUrl="~/Secretary/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image28" runat="server" ImageUrl="~/Secretary/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                            ...
                            <asp:FormView ID="FormViewStudentsAdditionalInformation" runat="server" DataKeyNames="StudentID"
                                ...
                                <EditItemTemplate>
                                    <table id="tblAdditionalInformation" width="100%">
                                        <tr>
                                            <td height="30" width="20">
                                                <asp:Image ID="Image91" runat="server" ImageUrl="~/Secretary/Images/LeftArrow.png" />
                                            </td>
                                            <td width="140">
                                        ...
                                        <tr>
                                            <td height="30" width="20">
                                                <asp:Image ID="Image92" runat="server" ImageUrl="~/Secretary/Images/LeftArrow.png" />
                                            </td>
                                            <td width="120">
                                        ...
                                        <tr>
                                            <td height="30" width="20">
                                                <asp:Image ID="Image93" runat="server" ImageUrl="~/Secretary/Images/LeftArrow.png" />
                                            </td>
                                            <td width="120">
                                        ...
                                        <tr>
                                            <td height="30" width="20">
                                                <asp:Image ID="Image94" runat="server" ImageUrl="~/Secretary/Images/LeftArrow.png" />
                                            </td>
                                            <td width="120">
                                        ...
                                        <tr>
                                            <td height="30" width="20">
                                                <asp:Image ID="Image95" runat="server" ImageUrl="~/Secretary/Images/LeftArrow.png" />
                                            </td>
                                            <td width="120">
                                        ...
                                        <tr>
                                            <td class="style1" valign="top" width="20">
                                                <asp:Image ID="Image126" runat="server" ImageUrl="~/Secretary/Images/LeftArrow.png" />
                                            </td>
                                        ...
                                        <tr>
                                            <td height="28" valign="top" width="20">
                                                <asp:Image ID="Image127" runat="server" ImageUrl="~/Secretary/Images/LeftArrow.png" />
                                            </td>
                            ...
                            <asp:FormView ID="FormViewStudentsEnrollmentDetails" runat="server" DataKeyNames="StudentID"
                                ...
                                <EditItemTemplate>
                                    <table id="tblEnrollmentDetails0" width="100%">
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image81" runat="server" ImageUrl="~/Secretary/Images/LeftArrow.png" />
                                            </td>
                                            <td height="25">
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image82" runat="server" ImageUrl="~/Secretary/Images/LeftArrow.png" />
                                            </td>
                                            <td height="25">
                                        ...
                                        <tr>
                                            <td height="25" valign="top">
                                                <asp:Image ID="Image72" runat="server" ImageUrl="~/Secretary/Images/LeftArrow.png" />
                                            </td>
                                            <td height="75" valign="top">
                                ...
                                <EditItemTemplate>
                                    <table id="tblGuardiansDetails0" width="100%">
                                        <tr>
                                            ...
                                            <td width="20">
                                                <asp:Image ID="Image124" runat="server" ImageUrl="~/Secretary/Images/LeftArrow.png" />
                                            </td>
                                            <td width="130">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Image ID="Image125" runat="server" ImageUrl="~/Secretary/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image46" runat="server" ImageUrl="~/Secretary/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td height="75" valign="top">
                                                <asp:Image ID="Image47" runat="server" ImageUrl="~/Secretary/Images/LeftArrow.png" />
                                            </td>
                                            <td valign="top">
                                        ...
                                        <tr>
                                            <td height="75" valign="top">
                                                <asp:Image ID="Image49" runat="server" ImageUrl="~/Secretary/Images/LeftArrow.png" />
                                            </td>
                                            <td valign="top">
                            ...
                            <asp:FormView ID="FormViewParentsParentsInformation" runat="server" DataSourceID="SqlDataSourceFormViewParentsParentsInformation"
                                ...
                                <EditItemTemplate>
                                    <table id="StudentTable1" width="100%">
                                        <tr>
                                            <td height="30" width="20">
                                                <asp:Image ID="Image128" runat="server" ImageUrl="~/Secretary/Images/LeftArrow.png" />
                                            </td>
                                            <td width="130">
                                            ...
                                            <td width="20">
                                                <asp:Image ID="Image129" runat="server" ImageUrl="~/Secretary/Images/LeftArrow.png" />
                                            </td>
                                            <td width="130">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Image ID="Image106" runat="server" ImageUrl="~/Secretary/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Image ID="Image109" runat="server" ImageUrl="~/Secretary/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image130" runat="server" ImageUrl="~/Secretary/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <asp:Image ID="Image90" runat="server" ImageUrl="~/Secretary/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td height="30" valign="top">
                                                <asp:Image ID="Image131" runat="server" ImageUrl="~/Secretary/Images/LeftArrow.png" />
                                            </td>
                                            <td valign="top">
                                            ...
                                            <td valign="top">
                                                <asp:Image ID="Image132" runat="server" ImageUrl="~/Secretary/Images/LeftArrow.png" />
                                            </td>
                                            <td valign="top">
                                        ...
                                        <tr>
                                            <td height="30" valign="top">
                                                <asp:Image ID="Image107" runat="server" ImageUrl="~/Secretary/Images/LeftArrow.png" />
                                            </td>
                                            <td valign="top">
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image133" runat="server" ImageUrl="~/Secretary/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <asp:Image ID="Image134" runat="server" ImageUrl="~/Secretary/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image135" runat="server" ImageUrl="~/Secretary/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <asp:Image ID="Image136" runat="server" ImageUrl="~/Secretary/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image137" runat="server" ImageUrl="~/Secretary/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <asp:Image ID="Image98" runat="server" ImageUrl="~/Secretary/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image138" runat="server" ImageUrl="~/Secretary/Images/LeftArrow.png" />
                                            </td>
                                            <td height="28">
