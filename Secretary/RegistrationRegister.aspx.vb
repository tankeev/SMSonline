...
Partial Class NewUserAccount
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If HttpContext.Current.User.Identity.IsAuthenticated And Not Profile.SchoolCode = Nothing Then

            Dim DropDownListSchools As DropDownList = CreateUserWizardStudent.CreateUserStep.ContentTemplateContainer.FindControl("DropDownListSchools")

            DropDownListSchools.SelectedValue = Profile.SchoolCode
    ...
    Protected Sub CreateUserWizard_CreatedUser(ByVal sender As Object, ByVal e As System.EventArgs) Handles CreateUserWizardStudent.CreatedUser
        Try
            ...
            Dim insertSql As String = "INSERT INTO tbl_Students(StudentID, ParentID, StudentName, SchoolCode, StartingAcademicTermID, StartingSectionID, CurrentSectionID, SchoolNo, [Continue], DateofBirth, BirthPlace, Gender, Religion, ContactPhone1, ContactEmail, IsOlympiad, OlympiadName, IsScholarship, ScholarshipPercentage, BloodType) VALUES (@StudentID, @ParentID, @StudentName, @SchoolCode, @StartingAcademicTermID, @StartingSectionID, @CurrentSectionID, @SchoolNo, @Continue , @DateofBirth, @BirthPlace, @Gender, @Religion, @ContactPhone1, @ContactEmail, @IsOlympiad, @OlympiadName, @IsScholarship, @ScholarshipPercentage, @BloodType)"
