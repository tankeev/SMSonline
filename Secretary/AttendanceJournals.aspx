                        ...
                        <asp:TemplateField ShowHeader="False">
                            <ItemTemplate>
                                <asp:ImageButton ID="ImageButton1" runat="server" CausesValidation="False" CommandName="Select"
                                    ImageUrl="~/Secretary/Images/cursor_hand.png" Text="Select" Width="24px" />
                            </ItemTemplate>
                ...
                <asp:DataList ID="DataListJurnal" runat="server" DataSourceID="SqlDataSourceAttendanceJournalsDetails"
                    ...
                    <EditItemTemplate>
                        <table style="border: 1px solid #808080" width="650">
                            ...
                            <tr>
                                <td height="25">
                                    <asp:Image ID="Image2" runat="server" ImageUrl="~/Secretary/Images/arrow.gif" />
                                </td>
                                <td height="25">
                                ...
                                <td>
                                    <asp:Image ID="Image5" runat="server" ImageUrl="~/Secretary/Images/arrow.gif" />
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:Image ID="Image6" runat="server" ImageUrl="~/Secretary/Images/arrow.gif" />
                                </td>
                                <td>
                            ...
                            <tr>
                                <td height="25">
                                    <asp:Image ID="Image4" runat="server" ImageUrl="~/Secretary/Images/arrow.gif" />
                                </td>
                                <td height="25">
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <asp:ImageButton ID="ImageButton2" runat="server" CommandArgument='<%# Eval("RegisterID") %>'
                                        CommandName="Edit" ImageUrl="~/Secretary/Images/edit.png" />
                                </td>
                                <td align="center">
                                    <asp:ImageButton ID="ImageButton3" runat="server" ImageUrl="~/Secretary/Images/Delete_bin.gif" />
