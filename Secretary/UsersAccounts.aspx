                    ...
                    <tr>
                        <td>
                            <asp:RadioButtonList ID="RadioButtonListSections" runat="server" AutoPostBack="True"
                                ...
                                RepeatColumns="4" Font-Size="X-Small" Width="95%">
                            </asp:RadioButtonList>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <ContentTemplate>
                            <asp:GridView ID="GridviewStudents" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSourceStudents"
                                ...
                                <Columns>
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <asp:Image ID="Image1" runat="server" ImageUrl="~/Secretary/Images/Item.png" />
                                        </ItemTemplate>
                        ...
                        <ContentTemplate>
                            <asp:GridView ID="GridviewParents" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSourceParents"
                                ...
                                <Columns>
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <asp:Image ID="ImageInfo" runat="server" ImageUrl="~/Secretary/Images/info.png" />
