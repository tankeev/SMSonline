<%@ Page Title="SIS Send Message to Parents" Language="VB" MasterPageFile="~/Site.Master"
    CodeFile="AdministratorsMessagetoParents.aspx.vb" Inherits="SendMessagetoParents" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel" runat="server">
        <ContentTemplate>
            ...
            <div class="content-right">
                <h2>
                    MESSAGE TO PARENTS</h2>
                <br />
                <asp:Panel ID="PanelMessageBox" runat="server" Width="680px">
                    <table width="100%">
                        <tr>
                            <td height="28">
                                <asp:Label ID="Label31" runat="server" Font-Bold="False" ForeColor="Red" Text="Write a message title please:"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td height="28">
                        ...
                        <tr>
                            <td height="28">
                                <asp:Label ID="Label32" runat="server" Font-Bold="False" ForeColor="Red" Text="Write your message here please:"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td height="28">
                                <asp:Label ID="Label30" runat="server" Font-Bold="True" Text="Select School:"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td height="28">
                        ...
                        <tr>
                            <td height="28">
                                <asp:Label ID="Label28" runat="server" Font-Bold="True" Text="Select Section:"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td height="100">
                        ...
                        <tr>
                            <td height="28">
                                <asp:Label ID="Label29" runat="server" Font-Bold="True" Text="Select Parents:"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td height="100">
                                <div style='overflow: auto; height: 100%;'>
                                    <asp:CheckBoxList ID="CheckBoxListStudents" runat="server" DataSourceID="SqlDataSourceParents"
                        ...
                        <tr>
                            <td>
                                <asp:Button ID="ButtonSendMessage" runat="server" Height="25px" Text="Send Message"
                                    ValidationGroup="Message" Width="650px" OnClientClick="return confirm('You are about to send this message to All Selected Parents, do you confirm?')" />
                            </td>
                        </tr>
                        <tr>
                            <td>
                ...
                <asp:SqlDataSource ID="SqlDataSourceParents" runat="server" ConnectionString="<%$ ConnectionStrings:SMSOnlineConnectionString %>"
                    SelectCommand="SELECT tbl_Parents.SchoolCode, aspnet_UsersInRoles.RoleId, aspnet_UsersInRoles.UserId, tbl_Parents.ResponsibleParent AS Username, tbl_Students.CurrentSectionID FROM aspnet_UsersInRoles INNER JOIN aspnet_Roles ON aspnet_UsersInRoles.RoleId = aspnet_Roles.RoleId INNER JOIN tbl_Parents ON aspnet_UsersInRoles.UserId = tbl_Parents.ResponsibleParentID INNER JOIN tbl_Students ON tbl_Parents.ResponsibleParentID = tbl_Students.ParentID WHERE (tbl_Parents.SchoolCode = @SchoolCode) AND (tbl_Students.CurrentSectionID = @CurrentSectionID) ORDER BY Username">
                    <SelectParameters>
                        <asp:ControlParameter ControlID="DropDownListSchoolCodes" Name="SchoolCode" PropertyName="SelectedValue" />
