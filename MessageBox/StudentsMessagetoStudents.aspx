<%@ Page Title="SIS Send Message to Students" Language="VB" MasterPageFile="~/Site.Master"
    CodeFile="StudentsMessagetoStudents.aspx.vb" Inherits="SendMessagetoStudents" %>
                ...
                <div id="divChild">
                    <asp:Panel ID="PanelMessageBox" runat="server" Width="680px">
                        <table width="100%">
                            <tr>
                                <td height="28">
                                    <asp:Label ID="Label29" runat="server" Font-Bold="False" ForeColor="Red" Text="Write a message title please:"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td height="28">
                            ...
                            <tr>
                                <td height="28">
                                    <asp:Label ID="Label30" runat="server" Font-Bold="False" ForeColor="Red" Text="Write your message here please:"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td height="100">
                                    <div style='overflow: auto; height: 100%;'>
                                        <asp:RadioButtonList ID="RadioButtonListSections" runat="server" AutoPostBack="True"
                                            ...
                                            RepeatColumns="8" Width="650px" Font-Size="X-Small">
                                        </asp:RadioButtonList>
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>
                                    <asp:Button ID="ButtonSendMessage" runat="server" Height="25px" OnClientClick="return confirm('You are about to send this message to all parents, do you confirm?')"
