<%@ Page Title="SIS Send Message to Parents" Language="VB" MasterPageFile="~/Site.Master"
    CodeFile="StaffMessagetoParents.aspx.vb" Inherits="SendMessagetoParents" %>
            ...
            <div class="content-right">
                ...
                <asp:Panel ID="PanelMessageBox" runat="server" Width="100%">
                    <table width="680">
                        ...
                        <tr>
                            <td height="28">
                                <asp:Label ID="Label29" runat="server" Font-Bold="True" Text="Select Students:"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td height="100">
                        ...
                        <tr>
                            <td>
                                <asp:Button ID="ButtonSendMessage" runat="server" Height="25px" Text="Send Message"
                                    ValidationGroup="Message" Width="650px" OnClientClick="return confirm('You are about to send this message to all parents, do you confirm?')" />
                            </td>
                        </tr>
                    </table>
                ...
                <asp:Panel ID="PanelAdded" runat="server" Visible="False" Width="680px" HorizontalAlign="Center">
                ...
                <asp:Panel ID="PanelWarning" runat="server" Visible="False" Width="680px" HorizontalAlign="Center">
                ...
                <asp:Panel ID="PanelCannotAccess" runat="server" Visible="False" Width="680px" HorizontalAlign="Center">
                    <br />
