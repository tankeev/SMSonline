<%@ Page Title="SIS Send Message to Staff" Language="VB" MasterPageFile="~/Site.Master"
    CodeFile="CoordinatorsMessagetoStaff.aspx.vb" Inherits="SendMessagetoStaff" %>
                        ...
                        <tr>
                            <td>
                                <asp:Button ID="ButtonSendMessage" runat="server" Height="25px" Text="Send Message"
                                    ...
                                    OnClientClick="return confirm('You are about to send this message to All Selected Staff, do you confirm?')" />
                            </td>
                        </tr>
                        <tr>
                            <td>
