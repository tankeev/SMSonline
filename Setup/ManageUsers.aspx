<%@ Page Title="Setup Manage Users" Language="VB" MasterPageFile="Setup.Master" AutoEventWireup="false"
    CodeFile="ManageUsers.aspx.vb" Inherits="ManageUsers" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel" runat="server">
        <ContentTemplate>
            ...
            <asp:GridView ID="GridviewUsers" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSourceUserList"
                Width="675px" AllowPaging="True" DataKeyNames="UserId">
                <Columns>
                    <asp:TemplateField>
                        <ItemTemplate>
            ...
            <asp:GridView ID="GridviewStudents" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                DataSourceID="SqlDataSourceStudents" PageSize="5" Width="675px">
                <Columns>
                    <asp:TemplateField>
                        <ItemTemplate>
            ...
            <asp:GridView ID="GridviewStaff" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                DataSourceID="SqlDataSourceStaff" PageSize="5" Width="675px">
                <Columns>
                    <asp:TemplateField>
                        <ItemTemplate>
            ...
            <asp:GridView ID="GridviewParents" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                DataSourceID="SqlDataSourceParents" PageSize="5" Width="675px">
                <Columns>
                    <asp:TemplateField>
                        <ItemTemplate>
...
UPDATE aspnet_Membership SET IsApproved = @IsApproved, IsLockedOut = @IsLockedOut WHERE (UserId = @UserId)">
                <FilterParameters>
...
UPDATE aspnet_Membership SET IsApproved = @IsApproved, IsLockedOut = @IsLockedOut WHERE (UserId = @UserId)">
            ...
            <asp:SqlDataSource ID="SqlDataSourceSchoolCodes" runat="server" ConnectionString="<%$ ConnectionStrings:SMSOnlineConnectionString %>"
                InsertCommand="INSERT INTO aspnet_Roles(RoleName) VALUES (@RoleName)" SelectCommand="SELECT SchoolCode, SchoolName FROM tbl_Schools">
                <InsertParameters>
                    <asp:Parameter Name="RoleName" />
                </InsertParameters>
            </asp:SqlDataSource>
