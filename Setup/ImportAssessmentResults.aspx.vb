                ...
                If CheckBox.Checked = True Then
                    ...
                    Else
                        ...
                        If CheckBox.Checked = True Then
                            ...
                            Dim deleteSql As String = "DELETE FROM tbl_AssessmentsStudentsAnswers WHERE (AssessmentID = @AssessmentID) and (StudentID = @StudentID)"
                            ...
                            For QuestionNo As Integer = 1 To GridViewRow.Cells.Count - 3
                                ...
                                Dim insertSql As String = "INSERT INTO tbl_AssessmentsStudentsAnswers(AssessmentID, AssessmentQuestionNo, StudentID, StudentAnswer) VALUES(@AssessmentID, @AssessmentQuestionNo, @StudentID, @StudentAnswer)"

                                Using myConnection As New SqlConnection(SMSOnlineConnectionString)
                                    myConnection.Open()
                                    Dim myCommand As New SqlCommand(insertSql, myConnection)
                                    myCommand.Parameters.AddWithValue("@AssessmentID", Trim(AssessmentID))
                                    myCommand.Parameters.AddWithValue("@AssessmentQuestionNo", Trim(QuestionNo))
                                    myCommand.Parameters.AddWithValue("@StudentID", StudentID)
