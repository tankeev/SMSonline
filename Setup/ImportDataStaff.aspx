<%@ Page Title="Setup Import Data Staff" Language="VB" MasterPageFile="Setup.Master"
    AutoEventWireup="false" CodeFile="ImportDataStaff.aspx.vb" Inherits="ImportData" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="ChildContent">
    ...
    <table width="680">
        ...
        <tr>
            ...
            <td>
                <asp:Image ID="Image1" runat="server" ImageUrl="~/Setup/Images/DataStaff.PNG" Width="550px" />
            </td>
        </tr>
    </table>
