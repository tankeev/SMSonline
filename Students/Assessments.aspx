        ...
        <ContentTemplate>
            <div class="content-left">
                ...
                <table class="content-table" width="230">
                    ...
                    <tr>
                        <td width="40">
                            <asp:HyperLink ID="HyperLinkAddNew1" runat="server" ImageUrl="~/Students/Images/editor.png"
                                NavigateUrl="~/Students/MPEResultsByCourses.aspx">Add New</asp:HyperLink>
                        </td>
                        <td>
                ...
                <table class="content-table" width="230">
                    <tr>
                        <td height="35">
                            <asp:Label ID="Label31" runat="server" Text="Given Courses"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td height="30">
            ...
            <div class="content-right">
                ...
                <asp:GridView ID="GridViewAssessments" runat="server" AutoGenerateColumns="False"
                    DataSourceID="SqlDataSourceAssessments" Width="100%" DataKeyNames="AssessmentID">
                    <Columns>
                        <asp:TemplateField>
                            <ItemTemplate>
                ...
                <asp:GridView ID="GridViewAssessmentsMarks" runat="server" AutoGenerateColumns="False"
                    DataSourceID="SqlDataSourceAssessmentsMarks" Width="100%">
                    <Columns>
                        <asp:TemplateField>
                            <ItemTemplate>
