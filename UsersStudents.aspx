    ...
    <asp:UpdatePanel ID="UpdatePanel" runat="server">
        <ContentTemplate>
            ...
            <div class="content-right">
                ...
                <asp:ModalPopupExtender ID="MPStudentInfo" runat="server" BackgroundCssClass="modalBackground"
                    CancelControlID="ButtonCloseStudentInfo" PopupControlID="PanelStudentInfo" TargetControlID="btnStudentInfo">
                                    ...
                                    <EditItemTemplate>
                                        <table id="tblBasicInformation" width="100%">
                                            <tr>
                                                ...
                                                <td width="240">
                                                    <asp:TextBox ID="TextBoxUserName" runat="server" Enabled="False" Text='<%# Bind("UserName") %>'
                                            ...
                                            <tr>
                                                <td height="30">
                                                    <asp:Image ID="Image29" runat="server" ImageUrl="~/Staff/Images/LeftArrow.png" />
                                                </td>
                                                <td>
