        ...
        <ContentTemplate>
            <div class="content-left">
                <h2>
                    MENU</h2>
                <br />
                <uc1:MenuAttendanceCoordinators ID="MenuAttendanceCoordinators1" runat="server" />
                <br />
                <table class="content-table" width="240">
                    ...
                    <tr>
                        <td height="28">
                            <asp:Label ID="Label49" runat="server" Font-Bold="True" ForeColor="Red" Text="Select Class Level Type:"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td height="28">
            ...
            <div class="content-right">
                ...
                <br />
                <asp:Label ID="Label128" runat="server" Font-Bold="True" Text="///////////// Section Register Data"></asp:Label>
                <br />
                <br />
                <table bgcolor="#F0F0F0" style="border: 1px solid #999999" width="675">
                    <tr>
                        <td height="35" width="25">
                            <asp:Image ID="Image5" runat="server" ImageUrl="~/Staff/Images/menu-alt-24.png" />
                        </td>
                        ...
                        <td>
                            <asp:DropDownList ID="DropDownListStaff" runat="server" DataSourceID="SqlDataSourceStaff"
                                DataTextField="StaffName" DataValueField="StaffID" Width="97%" Enabled="False">
                            </asp:DropDownList>
                        </td>
                        <td width="35">
                            &nbsp;
                    ...
                    <tr>
                        <td height="35">
                            <asp:Image ID="Image6" runat="server" ImageUrl="~/Staff/Images/menu-alt-24.png" />
                        </td>
                        <td height="35">
                            <asp:Label ID="Label29" runat="server" Font-Bold="True" ForeColor="#CC0000" Text="Subject Title:"></asp:Label>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td valign="top">
                            <asp:Label ID="Label31" runat="server" Font-Bold="True" ForeColor="#CC0000" Text="Subject Journal:"></asp:Label>
                        </td>
                        <td>
                ...
                <asp:Panel ID="PanelAttendance" runat="server" Visible="False">
                    ...
                    <br />
                    <asp:Label ID="Label48" runat="server" Font-Bold="True" Text="///////////// Section Student List"></asp:Label>
                    <br />
                    <br />
                    <asp:Label ID="Label127" runat="server" Font-Bold="True" ForeColor="#CC0000" Text="Additional Notes column is optional, may be used for late comers to indicate how much late they are."></asp:Label>
                    <br />
                    <br />
                ...
                <asp:SqlDataSource ID="SqlDataSourceCourses" runat="server" ConnectionString="<%$ ConnectionStrings:SMSOnlineConnectionString %>"
                    SelectCommand="SELECT DISTINCT CourseCategory FROM vw_Courses WHERE (SchoolCode = @SchoolCode) AND (AcademicTermID = @AcademicTermID) ORDER BY CourseCategory">
                    <SelectParameters>
                        <asp:ControlParameter ControlID="DropDownListSchoolCodesMaster" Name="SchoolCode"
                            PropertyName="SelectedValue" />
