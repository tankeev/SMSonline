        ...
        <ContentTemplate>
            <div class="content-left">
                ...
                <table class="content-table" width="240">
                    <tr>
                        <td height="28">
                            <asp:Label ID="Label135" runat="server" Font-Bold="True" Text="Select School Section"
            ...
            <div class="content-right">
                ...
                <asp:SqlDataSource ID="SqlDataSourceAssessmentsMarks" runat="server" ConnectionString="<%$ ConnectionStrings:SMSOnlineConnectionString %>"
                    SelectCommand="SELECT StudentID, StudentName, AssessmentMark AS Score, Assessment, Excused, StaffName FROM vw_AssessmentMarks WHERE (AssessmentID = @AssessmentID) ORDER BY StudentName">
                    <SelectParameters>
