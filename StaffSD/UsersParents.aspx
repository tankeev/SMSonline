        ...
        <ContentTemplate>
            ...
            <div class="content-right">
                                    ...
                                    <table id="StudentTable0" width="100%">
                                        <tr>
                                            <td height="30" width="20">
                                                <asp:Image ID="Image55" runat="server" ImageUrl="~/StaffSD/Images/LeftArrow.png" />
                                            </td>
                                            <td width="140">
                                        ...
                                        <tr>
                                            <td height="30" width="20">
                                                <asp:Image ID="Image65" runat="server" ImageUrl="~/StaffSD/Images/LeftArrow.png" />
                                            </td>
                                            <td width="140">
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image57" runat="server" ImageUrl="~/StaffSD/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image59" runat="server" ImageUrl="~/StaffSD/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image63" runat="server" ImageUrl="~/StaffSD/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image64" runat="server" ImageUrl="~/StaffSD/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td height="75" valign="top">
                                                <asp:Image ID="Image61" runat="server" ImageUrl="~/StaffSD/Images/LeftArrow.png" />
                                            </td>
                                            <td valign="top">
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image62" runat="server" ImageUrl="~/StaffSD/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                            ...
                            <asp:FormView ID="FormViewParentsNotes" runat="server" DataKeyNames="ResponsibleParentID"
                                ...
                                <EditItemTemplate>
                                    <table id="StudentTable2" width="100%">
                                        ...
                                        <tr>
                                            <td height="75" valign="top">
                                                <asp:Image ID="Image129" runat="server" ImageUrl="~/StaffSD/Images/LeftArrow.png" />
                                            </td>
                                            <td valign="top">
                                        ...
                                        <tr>
                                            <td height="75" valign="top">
                                                <asp:Image ID="Image130" runat="server" ImageUrl="~/StaffSD/Images/LeftArrow.png" />
                                            </td>
                                            <td valign="top">
                ...
                <asp:SqlDataSource ID="SqlDataSourceListBoxParents" runat="server" ConnectionString="<%$ ConnectionStrings:SMSOnlineConnectionString %>"
                    SelectCommand="SELECT ResponsibleParentID, ResponsibleParent, CurrentSectionID, SchoolCode, SectionSchool FROM vw_Parents WHERE (SchoolCode = @SchoolCode) AND (SectionSchool = @IsSD OR SectionSchool = @IsSMP OR SectionSchool = @IsSMA) ORDER BY ResponsibleParent"
                    FilterExpression="CurrentSectionID={1}">
                    <FilterParameters>
