Partial Class Assignments
    ...
    Protected Sub GridViewComments_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GridViewComments.RowDataBound
        Try
            Dim GridViewCommentsRow As GridViewRow = e.Row

            If GridViewCommentsRow.RowType = DataControlRowType.DataRow Then
                ...
                Dim FormViewReportComments As FormView = GridViewCommentsRow.FindControl("FormViewReportComments")
