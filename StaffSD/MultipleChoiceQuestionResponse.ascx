    ...
    <tr>
        ...
        <td width="35">
            <asp:RequiredFieldValidator ID="RequiredFieldValidatorMCResponse" runat="server"
                ControlToValidate="TextBoxMCResponse" ErrorMessage="(*)" ForeColor="Red" ValidationGroup="NewQuestion">(*)</asp:RequiredFieldValidator>
        </td>
    </tr>
    <tr>
        ...
        <td width="200">
            <asp:RadioButton ID="RadioButtonIsAnswer" runat="server" Text="Is Correct Answer?"
