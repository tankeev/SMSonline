        ...
        <ContentTemplate>
            <div class="content-left">
                ...
                <table class="content-table" width="240">
                    <tr>
                        <td height="28">
                            <asp:Label ID="Label174" runat="server" Font-Bold="True" ForeColor="Red" Text="Select Print Date"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td height="28">
                            <asp:TextBox ID="TextBoxDate" runat="server" ValidationGroup="Date" Width="90%"></asp:TextBox>
                    ...
                    <tr>
                        <td height="28">
                            <asp:Label ID="Label175" runat="server" Font-Bold="True" ForeColor="Red" Text="Select Section"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>
            ...
            <div class="content-right">
                ...
                <asp:TabContainer ID="TabContainer" runat="server" ActiveTabIndex="0" CssClass="tab"
                        ...
                        <ContentTemplate>
                            ...
                            <asp:GridView ID="GridViewMidReport" runat="server" AutoGenerateColumns="False" DataKeyNames="StudentID"
                                ...
                                <Columns>
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <asp:Image ID="Image3" runat="server" ImageUrl="Images/Item.png" />
                                        </ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="HTM">
                                        <ItemTemplate>
                                            <asp:HyperLink ID="HyperLinkReport" runat="server" ImageUrl="Images/htm_png.png"
                                    ...
                                    <asp:TemplateField HeaderText="PDF">
                                        <ItemTemplate>
                                            <asp:Image ID="ImaDge2" runat="server" ImageUrl="Images/pdf_png.png" />
                                        </ItemTemplate>
                                        <HeaderStyle HorizontalAlign="Center" />
                                        <ItemStyle HorizontalAlign="Center" Width="50px" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="PRINT">
                                        <ItemTemplate>
                                            <asp:Image ID="ImaDDge2" runat="server" ImageUrl="Images/printer.png" />
                                        </ItemTemplate>
                                        <HeaderStyle HorizontalAlign="Center" />
                                        <ItemStyle HorizontalAlign="Center" Width="50px" />
                                    </asp:TemplateField>
                    ...
                    <asp:TabPanel ID="TabPanel2" runat="server" HeaderText="TabPanel2">
                        ...
                        <ContentTemplate>
                            <br />
                            <asp:DropDownList ID="DropDownListAcademicSemesters" runat="server" DataSourceID="SqlDataSourceAcademicSemesters0"
                            ...
                            <asp:GridView ID="GridViewFinalReport" runat="server" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <asp:Image ID="Image4" runat="server" ImageUrl="Images/Item.png" />
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Center" Width="35px" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="StudentID" SortExpression="StudentID" Visible="False">
                                    ...
                                    <asp:TemplateField HeaderText="PDF">
                                        <ItemTemplate>
                                            <asp:Image ID="ImaDge3" runat="server" ImageUrl="Images/pdf_png.png" />
                                        </ItemTemplate>
                                        <HeaderStyle HorizontalAlign="Center" />
                                        <ItemStyle HorizontalAlign="Center" Width="50px" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="PRINT">
                                        <ItemTemplate>
                                            <asp:Image ID="ImaDDge3" runat="server" ImageUrl="Images/printer.png" />
                                        </ItemTemplate>
                                        <HeaderStyle HorizontalAlign="Center" />
                                        <ItemStyle HorizontalAlign="Center" Width="50px" />
                                    </asp:TemplateField>
                            ...
                            <asp:SqlDataSource ID="SqlDataSourceAcademicSemesters0" runat="server" ConnectionString="<%$ ConnectionStrings:SMSOnlineConnectionString %>"
                ...
                <asp:SqlDataSource ID="SqlDataSourceReportsStudents" runat="server" ConnectionString="<%$ ConnectionStrings:SMSOnlineConnectionString %>"
                    SelectCommand="SELECT StudentID, StudentName, SchoolCode FROM tbl_Students WHERE (CurrentSectionID = @CurrentSectionID) AND (SchoolCode = @SchoolCode) ORDER BY StudentName">
                    <SelectParameters>
