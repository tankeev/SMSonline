...
<table class="content-table" width="240">
    ...
    <tr>
        <td width="60" height="50" align="center">
            <asp:HyperLink ID="HyperLinkAttendanceChecklist" runat="server" ImageUrl="~/StaffSD/Images/menu_attendance_checklist.png"
                NavigateUrl="~/StaffSD/AttendanceChecklist.aspx"></asp:HyperLink>
        </td>
        <td width="60" align="center">
            <asp:HyperLink ID="HyperLinkAttendanceArchive" runat="server" ImageUrl="~/StaffSD/Images/menu_attendance_archive.png"
                NavigateUrl="~/StaffSD/AttendanceArchive.aspx"></asp:HyperLink>
        </td>
        <td width="60" align="center">
            <asp:HyperLink ID="HyperLinkAttendanceReports" runat="server" ImageUrl="~/StaffSD/Images/menu_attendance_reports.png"
                NavigateUrl="~/StaffSD/AttendanceReports.aspx"></asp:HyperLink>
        </td>
        <td align="center" width="60">
            <asp:HyperLink ID="HyperLinkAttendanceJournals" runat="server" ImageUrl="~/StaffSD/Images/menu_attendance_journal.png"
                NavigateUrl="~/StaffSD/AttendanceJournals.aspx"></asp:HyperLink>
        </td>
    </tr>
</table>
