...
<table class="content-table" width="240">
    <tr>
        <td width="60" height="50">
            <asp:HyperLink ID="HyperLinkUsersSearch" runat="server" ImageUrl="~/StaffSD/Images/menu_search.png"
                NavigateUrl="~/StaffSD/UsersSearch.aspx"></asp:HyperLink>
        </td>
        <td width="60">
            <asp:HyperLink ID="HyperLinkStudents" runat="server" ImageUrl="~/StaffSD/Images/menu_students.png"
                NavigateUrl="~/StaffSD/UsersStudents.aspx"></asp:HyperLink>
        </td>
        <td width="60">
            <asp:HyperLink ID="HyperLinkParents" runat="server" ImageUrl="~/StaffSD/Images/menu_parents.png"
                NavigateUrl="~/StaffSD/UsersParents.aspx"></asp:HyperLink>
        </td>
        <td width="60">
            &nbsp;
        </td>
