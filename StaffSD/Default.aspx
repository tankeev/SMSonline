            ...
            <tr>
                <td>
                    <asp:FormView ID="FormViewUserProfile" runat="server" DataSourceID="SqlDataSourceStaffProfile"
                        Width="100%">
                        <ItemTemplate>
                            <asp:Image ID="ImageStudent" runat="server" ImageUrl="~/Students/Images/StudentProfile.png"
                                Width="128px" />
                            <br />
                            User Name:
                            <br />
                            ...
                            <br />
                            <br />
                            User Roles:<asp:DataList ID="DataListRoles" runat="server" DataSourceID="SqlDataSourceRoles">
                                <ItemTemplate>
