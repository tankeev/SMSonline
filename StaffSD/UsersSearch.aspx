        ...
        <ContentTemplate>
            <div class="content-left">
                ...
                <table class="content-table" width="240">
                    <tr>
                        <td width="40">
                            <asp:HyperLink ID="HyperLinkUsersSearchTable" runat="server" ImageUrl="~/StaffSD/Images/menu_search.png"
                    ...
                    <tr>
                        <td width="40">
                            <asp:HyperLink ID="HyperLinkStudentsTable" runat="server" ImageUrl="~/Staff/Images/menu_students.png"
                                NavigateUrl="~/Staff/Students.aspx">Add New</asp:HyperLink>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td width="40">
                            <asp:HyperLink ID="HyperLinkParentsTable" runat="server" ImageUrl="~/Staff/Images/menu_parents.png"
                                NavigateUrl="~/Staff/Parents.aspx">Add New</asp:HyperLink>
                        </td>
                        <td>
                ...
                <div id="divChild">
                    ...
                    <asp:GridView ID="GridviewUsers" runat="server" AutoGenerateColumns="False" Width="675px"
                        ...
                        <Columns>
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:Image ID="Image1" runat="server" ImageUrl="~/StaffSD/Images/edit.png" />
                                </ItemTemplate>
                        ...
                        <EmptyDataTemplate>
                            <div align="center">
                                <br />
                                <asp:Image ID="Image41" runat="server" ImageUrl="~/StaffSD/Images/warning.png" />
                                <br />
                                <br />
                                <br />
                    ...
                    <asp:Panel ID="PanelStudents" runat="server">
                        <div id="divEmptyStudents" align="center">
                            <br />
                            <asp:Image ID="Image48" runat="server" ImageUrl="~/StaffSD/Images/warning.png" />
                            <br />
                            <br />
                            <br />
                    ...
                    <asp:GridView ID="GridviewStudents" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:Image ID="Image42" runat="server" ImageUrl="~/StaffSD/Images/edit.png" />
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Center" Width="25px" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="School Name">
                        ...
                        <EmptyDataTemplate>
                            <div align="center">
                                <br />
                                <asp:Image ID="Image43" runat="server" ImageUrl="~/StaffSD/Images/warning.png" />
                                <br />
                                <br />
                                <br />
                    ...
                    <asp:Panel ID="PanelStaff" runat="server">
                        <div id="divEmptyStaff" align="center">
                            <br />
                            <asp:Image ID="Image49" runat="server" ImageUrl="~/StaffSD/Images/warning.png" />
                            <br />
                            <br />
                            <br />
                    ...
                    <asp:GridView ID="GridviewStaff" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:Image ID="Image44" runat="server" ImageUrl="~/StaffSD/Images/edit.png" />
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Center" Width="25px" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="School Name">
                        ...
                        <EmptyDataTemplate>
                            <div align="center">
                                <br />
                                <asp:Image ID="Image45" runat="server" ImageUrl="~/StaffSD/Images/warning.png" />
                                <br />
                                <br />
                                <br />
                    ...
                    <asp:Panel ID="PanelParents" runat="server">
                        <div id="divEmptyParents" align="center">
                            <br />
                            <asp:Image ID="Image50" runat="server" ImageUrl="~/StaffSD/Images/warning.png" />
                            <br />
                            <br />
                            <br />
                    ...
                    <asp:GridView ID="GridviewParents" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:Image ID="Image46" runat="server" ImageUrl="~/StaffSD/Images/edit.png" />
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Center" Width="25px" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="School Name">
                        ...
                        <EmptyDataTemplate>
                            <div align="center">
                                <br />
                                <asp:Image ID="Image47" runat="server" ImageUrl="~/StaffSD/Images/warning.png" />
                                <br />
                                <br />
                                <br />
