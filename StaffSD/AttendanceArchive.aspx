        ...
        <ContentTemplate>
            ...
            <div class="content-right">
                ...
                <asp:GridView ID="GridViewAttendanceTypes" runat="server" AutoGenerateColumns="False"
                    DataKeyNames="AttendanceTypeID" DataSourceID="SqlDataSourceAttendanceTypes" Width="630px"
                    Visible="False">
                    <Columns>
            ...
            <asp:SqlDataSource ID="SqlDataSourceStudents" runat="server" ConnectionString="<%$ ConnectionStrings:SMSOnlineConnectionString %>"
                SelectCommand="SELECT SchoolCode, CurrentSectionID, StudentID, StudentName, Date, [1], [2], [3], [4], [5], [6], [7], [8], [9] FROM vw_Attendance WHERE (Date = @Date) AND (SchoolCode = @SchoolCode) AND (CurrentSectionID = @CurrentSectionID) ORDER BY StudentName"
