                    ...
                    <asp:TabPanel ID="TabPanel1" runat="server" HeaderText="TabPanel1">
                        ...
                        <ContentTemplate>
                            ...
                            <asp:SqlDataSource ID="SqlDataSourceStudents" runat="server" ConnectionString="<%$ ConnectionStrings:SMSOnlineConnectionString %>"
                                SelectCommand="SELECT StudentID, StudentName, Gender, UserName, SectionCatalogID, LastActivityDate FROM vw_AcademicTermsStudents WHERE (SectionCatalogID = @SectionCatalogID) AND (AcademicTermID = @AcademicTermID) AND (SchoolCode = @SchoolCode)"
                        ...
                        <ContentTemplate>
                            <asp:GridView ID="GridviewParents" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSourceParents"
                                ...
                                <Columns>
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <asp:Image ID="ImageInfo" runat="server" ImageUrl="~/Coordinators/Images/info.png" />
