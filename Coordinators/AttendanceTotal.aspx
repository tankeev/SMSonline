        ...
        <ContentTemplate>
            <div class="content-left">
                ...
                <table class="content-table" width="240">
                    ...
                    <tr>
                        <td width="40">
                            <asp:HyperLink ID="HyperLinkViewd" runat="server" ImageUrl="~/Coordinators/Images/menu_view.png"
                                NavigateUrl="~/Coordinators/AttendanceReports.aspx"></asp:HyperLink>
                        </td>
                        <td>
                            <asp:Label ID="Label34" runat="server" Text="Attendance Report"></asp:Label>
                        </td>
                    </tr>
                </table>
                <br />
            ...
            <div class="content-right">
                ...
                <asp:GridView ID="GridViewAttendanceTotal" runat="server" AutoGenerateColumns="False"
                    ...
                    DataKeyNames="StudentID" ShowHeader="False">
                    <Columns>
                        <asp:TemplateField>
                            <ItemTemplate>
