<%@ Page Title="SIS Add New Staff" Language="VB" MasterPageFile="~/Site.Master" AutoEventWireup="false"
    CodeFile="UsersStaffAddNewStaff.aspx.vb" Inherits="NewStaffAccount" %>
        ...
        <ContentTemplate>
            ...
            <div class="content-right">
                <h2>
                    ADD NEW STAFF</h2>
                <br />
                <asp:CreateUserWizard ID="CreateUserWizardStaff" runat="server" ContinueDestinationPageUrl="~/Coordinators/UsersStaffAddNewStaff.aspx"
                        ...
                        <asp:CreateUserWizardStep runat="server">
                            <ContentTemplate>
                                <table id="CoordinatorsTable" width="100%">
                                    ...
                                    <tr>
                                        <td height="28">
                                            <asp:Image ID="Image31" runat="server" ImageUrl="~/Coordinators/Images/LeftArrow.png" />
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td align="center" height="25">
                                            <asp:Image ID="Image22" runat="server" 
                                                ImageUrl="~/Coordinators/Images/success.png" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="center" height="25">
