<%@ Page Title="SIS Students" Language="VB" MasterPageFile="~/Site.Master" CodeFile="UsersStudentsCancelledEnrollments.aspx.vb"
    Inherits="Students" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel" runat="server">
        <ContentTemplate>
                ...
                <table class="content-table" width="240">
                    <tr>
                        <td height="50" width="60">
                            <asp:HyperLink ID="HyperLinkStudents" runat="server" ImageUrl="~/Coordinators/Images/menu_students.png"
                                NavigateUrl="~/Coordinators/UsersStudents.aspx" ToolTip="Student Details"></asp:HyperLink>
                        </td>
                        <td width="60">
                            <asp:HyperLink ID="HyperLinkUsersCancel0" runat="server" ImageUrl="~/Coordinators/Images/menu_remove.png"
                                NavigateUrl="~/Coordinators/UsersStudentsCancelledEnrollments.aspx" ToolTip="Cancelled Enrollments"></asp:HyperLink>
                        </td>
                        <td width="60">
                            <asp:HyperLink ID="HyperLinkAddNewStudent0" runat="server" ImageUrl="~/Coordinators/Images/menu_add.png"
                                NavigateUrl="~/Coordinators/UsersStudentsAddNewStudent.aspx" ToolTip="Add New Student"></asp:HyperLink>
                        </td>
                        <td width="60">
                            &nbsp;</td>
                    </tr>
            ...
            <div class="content-right">
                ...
                <uc3:WebMessageBox ID="WebMessageBoxStudents" runat="server" />
            </div>
        </ContentTemplate>
    </asp:UpdatePanel>
</asp:Content>
