...
<table class="content-table" width="240">
    ...
    <tr>
        <td width="50" height="50" align="center">
            <asp:HyperLink ID="HyperLinkAttendanceChecklist" runat="server" ImageUrl="~/Coordinators/Images/menu_attendance_checklist.png"
                NavigateUrl="~/Coordinators/AttendanceChecklist.aspx"></asp:HyperLink>
        </td>
        <td width="50" align="center">
            <asp:HyperLink ID="HyperLinkAttendanceArchive" runat="server" ImageUrl="~/Coordinators/Images/menu_attendance_archive.png"
                NavigateUrl="~/Coordinators/AttendanceArchive.aspx"></asp:HyperLink>
        </td>
        <td width="50" align="center">
            <asp:HyperLink ID="HyperLinkAttendanceReports" runat="server" ImageUrl="~/Coordinators/Images/menu_attendance_reports.png"
                NavigateUrl="~/Coordinators/AttendanceReports.aspx"></asp:HyperLink>
        </td>
        <td align="center">
            <asp:HyperLink ID="HyperLinkAttendanceJournals" runat="server" ImageUrl="~/Coordinators/Images/menu_attendance_journal.png"
                NavigateUrl="~/Coordinators/AttendanceJournals.aspx"></asp:HyperLink>
        </td>
    </tr>
</table>
