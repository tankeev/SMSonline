<%@ Page Title="SIS Study Skills & Comments" Language="VB" MasterPageFile="~/Site.Master"
        ...
        <ContentTemplate>
            <div class="content-left">
                ...
                <table class="content-table" width="240">
                    <tr>
                        <td height="28">
                            <asp:Label ID="Label149" runat="server" Font-Bold="True" Text="Select Semester" ForeColor="Red"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td height="28">
            ...
            <div class="content-right">
                ...
                <asp:GridView ID="GridViewStudents" runat="server" AutoGenerateColumns="False" DataKeyNames="StudentID"
                    DataSourceID="SqlDataSourceStudents" Width="680px" ShowHeader="False" AllowPaging="True"
                    PageSize="5">
                    <Columns>
                                                    ...
                                                    <asp:FormView ID="FormViewReportComments" runat="server" DataKeyNames="CommentID"
                                                        ...
                                                        <EditItemTemplate>
                                                            <table width="100%">
                                                                ...
                                                                <tr>
                                                                    <td width="60%">
                                                                        <asp:Button ID="ButtonUpdate" runat="server" CommandName="Update" Text="Update" Width="90%" />
                                                                    </td>
                                                                    <td>
                                                                        <asp:Button ID="ButtonCancel" runat="server" CausesValidation="False" CommandName="Cancel"
                                                                            OnClick="ButtonInsert_Click" Text="Cancel" Width="90%" />
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </EditItemTemplate>
                                                        ...
                                                        <InsertItemTemplate>
                                                            <table width="100%">
                                                                ...
                                                                <tr>
                                                                    <td width="60%">
                                                                        <asp:Button ID="ButtonInsert" runat="server" CommandName="Insert" Text="Insert" Width="90%" />
                                                                    </td>
                                                                    <td>
                                                                        <asp:Button ID="ButtonCancel" runat="server" CausesValidation="False" CommandName="Cancel"
                                                                            OnClick="ButtonInsert_Click" Text="Cancel" Width="90%" />
                                                        ...
                                                        <ItemTemplate>
                                                            <table width="100%">
                                                                <tr>
                                                                    <td height="75" valign="top" colspan="2">
                                                                        <asp:Label ID="CommentLabel" runat="server" Text='<%# Bind("Comment") %>' Width="95%" />
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td valign="top" width="60%">
...
INSERT INTO tbl_ReportComments(AcademicSemesterID, StudentID, Comment, WrittenBy, AcademicTermID, ReportTypeID, CourseCatalogID, CourseSectionID) VALUES (@AcademicSemesterID, @StudentID, @Comment, @WrittenBy, @AcademicTermID, 2, 0, 0)"
                    ...
                    <EmptyDataTemplate>
                        <asp:Panel ID="PanelEmpty" runat="server" HorizontalAlign="Center">
                            <br />
                            <asp:Image ID="ImageEmpty" runat="server" ImageUrl="~/Coordinators/Images/no-data.png" />
                            <br />
                            <br />
                            <br />
                            <asp:Label ID="LabelWarning" runat="server" Font-Bold="True" ForeColor="Red" Text="Please Select a School Section to see the Students!"
                ...
                <asp:SqlDataSource ID="SqlDataSourceSections" runat="server" ConnectionString="<%$ ConnectionStrings:SMSOnlineConnectionString %>"
                    SelectCommand="SELECT DISTINCT tbl_SectionMentors.SectionCatalogID, tbl_SectionCatalog.SectionCatalog, tbl_SectionCatalog.SectionGroup FROM tbl_SectionMentors INNER JOIN tbl_SectionCatalog ON tbl_SectionMentors.SectionCatalogID = tbl_SectionCatalog.SectionCatalogID WHERE (tbl_SectionMentors.IsDefault = 1) AND (tbl_SectionMentors.SchoolCode = @SchoolCode) AND (tbl_SectionMentors.AcademicSemesterID = @AcademicSemesterID) ORDER BY tbl_SectionCatalog.SectionGroup">
                    <SelectParameters>
