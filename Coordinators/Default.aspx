...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
            ...
            <tr>
                <td>
                    <asp:GridView ID="GridViewNumberofStudents" runat="server" AutoGenerateColumns="False"
                        DataSourceID="SqlDataSourceNumberofStudents" Width="95%" ShowFooter="True">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Total" SortExpression="Total">
                                <FooterTemplate>
                                    <asp:Label ID="LabelTotalSum" runat="server" Font-Size="X-Small" 
    ...
    <asp:SqlDataSource ID="SqlDataSourceNumberofStudents" runat="server" ConnectionString="<%$ ConnectionStrings:SMSOnlineConnectionString %>"
        SelectCommand="SELECT SectionCatalog, Total FROM vw_NumberofStudentsinClasses WHERE (SchoolCode = @SchoolCode) AND (AcademicTermID = @AcademicTermID) ORDER BY SectionGroup, SectionCatalog">
        <SelectParameters>
            <asp:ProfileParameter Name="SchoolCode" PropertyName="SchoolCode" />
