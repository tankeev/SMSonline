<%@ Page Title="SIS Staff" Language="VB" MasterPageFile="~/Site.Master" CodeFile="UsersStaffCancelledContracts.aspx.vb"
    Inherits="Staff" %>
                ...
                <table class="content-table" width="240">
                    <tr>
                        <td height="50" width="60">
                            <asp:HyperLink ID="HyperLinkStaff" runat="server" 
                                ImageUrl="~/Coordinators/Images/menu_details.png" 
                                NavigateUrl="~/Coordinators/UsersStaff.aspx" ToolTip="Staff Details"></asp:HyperLink>
                        </td>
                        <td width="60">
                            <asp:HyperLink ID="HyperLinkAddNewStaff" runat="server" 
                                ImageUrl="~/Coordinators/Images/menu_add.png" 
                                NavigateUrl="~/Coordinators/UsersStaffAddNewStaff.aspx" ToolTip="Add New Staff"></asp:HyperLink>
                        </td>
                        <td width="60">
                            <asp:HyperLink ID="HyperLinkStaffCancel" runat="server" 
                                ImageUrl="~/Coordinators/Images/menu_remove.png" 
                                NavigateUrl="~/Coordinators/UsersStaffCancelledContracts.aspx" 
                                ToolTip="Cancelled Contract"></asp:HyperLink>
                        </td>
                        <td width="60">
                            &nbsp;</td>
                    </tr>
                            ...
                            <asp:FormView ID="FormViewStaffOverview" runat="server" DataKeyNames="StaffID" DataSourceID="SqlDataSourceFormViewStaffOverview"
                                ...
                                <EditItemTemplate>
                                    <table id="StudentTable" width="100%">
                                        ...
                                        <tr>
                                            <td height="30" width="20">
                                                <asp:Image ID="Image51" runat="server" ImageUrl="~/Coordinators/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image28" runat="server" ImageUrl="~/Coordinators/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image48" runat="server" ImageUrl="~/Coordinators/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                            ...
                            <asp:FormView ID="FormViewStaffAdditional" runat="server" DataKeyNames="StaffID"
                                ...
                                <EditItemTemplate>
                                    <table id="StudentTable0" width="100%">
                                            ...
                                            <td rowspan="11" valign="top">
                                                ...
                                                <asp:UpdatePanel ID="UpdatePanelPhoto" runat="server">
                                                    <ContentTemplate>
                                                        ...
                                                        <br />
                                                        <br />
                                                        <asp:Label ID="LabelStatusPhoto0" runat="server" ForeColor="Red"></asp:Label>
                                                        <br />
                                                        <br />
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image73" runat="server" ImageUrl="~/Coordinators/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image74" runat="server" ImageUrl="~/Coordinators/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image75" runat="server" ImageUrl="~/Coordinators/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td valign="top">
                                                <asp:Button ID="ButtonUpdateStaffAdditional" runat="server" CommandName="Update"
                                ...
                                <EditItemTemplate>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="TextBoxContractStart" runat="server" meta:resourcekey="TextBoxStartingGradeResource1"
                                                    Text='<%# Bind("ContractStartDate") %>' Width="220px"></asp:TextBox>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="TextBoxContractExpire" runat="server" meta:resourcekey="TextBoxStartingGradeResource1"
                                                    Text='<%# Bind("ContractExpDate") %>' Width="220px"></asp:TextBox>
                                    ...
                                    <table id="StudentDetails1" width="100%">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Button ID="ButtonUpdateStaffAcademic" runat="server" CommandName="Update" Text="Update Changes"
                                                    Width="230px" />
                                            </td>
                                        </tr>
                                    </table>
...
INSERT INTO aspnet_UsersInRoles (UserID, RoleID) VALUES (@UserID,@RoleID)">
                ...
                <br />
                <br />
                <uc2:WebMessageBox ID="WebMessageBoxStaff" runat="server" />
                <asp:SqlDataSource ID="SqlDataSourceListBoxStaff" runat="server" ConnectionString="<%$ ConnectionStrings:SMSOnlineConnectionString %>"
                    
                    SelectCommand="SELECT StaffID, StaffName FROM tbl_Staff WHERE (SchoolCode = @SchoolCode) AND ([Continue] = 0) ORDER BY StaffName">
                    <SelectParameters>
