            ...
            <div class="content-left">
                ...
                <table class="content-table" width="240">
                    <tr>
                        ...
                        <td width="75">
                            <asp:Label ID="Label52" runat="server" Font-Bold="True" ForeColor="Red" Text="(P) "></asp:Label>
                            <asp:Label ID="Label53" runat="server" Text="Present"></asp:Label>
                        </td>
                        <td width="25">
                            <asp:Panel ID="PanelSickLeave1" runat="server" BackColor="#FFFF99" BorderWidth="1px"
                                Height="20px" Width="20px">
                            </asp:Panel>
                        </td>
                        <td>
                            <asp:Label ID="Label54" runat="server" Font-Bold="True" ForeColor="Red" Text="(S) "></asp:Label>
                            <asp:Label ID="Label55" runat="server" Text="Sick"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td width="25">
                            <asp:Panel ID="PanelPresent3" runat="server" BackColor="#009933" BorderWidth="1px"
                                Height="20px" Width="20px">
                            </asp:Panel>
                        </td>
                        <td>
                            <asp:Label ID="Label56" runat="server" Font-Bold="True" ForeColor="Red" Text="(L) "></asp:Label>
                            <asp:Label ID="Label57" runat="server" Text="Late"></asp:Label>
                        </td>
                        <td width="25">
                            <asp:Panel ID="PanelAbsentwithLeave1" runat="server" BackColor="#FF6699" BorderWidth="1px"
                                Height="20px" Width="20px">
                            </asp:Panel>
                        </td>
                        <td>
                            <asp:Label ID="Label58" runat="server" Font-Bold="True" ForeColor="Red" Text="(O) "></asp:Label>
                            <asp:Label ID="Label59" runat="server" Text="Olympiad"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td width="25">
                        ...
                        <td>
                            <asp:Label ID="Label60" runat="server" Font-Bold="True" ForeColor="Red" Text="(A) "></asp:Label>
                            <asp:Label ID="Label61" runat="server" Text="Absent"></asp:Label>
                        </td>
                        <td width="25">
                        ...
                        <td>
                            <asp:Label ID="Label62" runat="server" Font-Bold="True" ForeColor="Red" Text="(I) "></asp:Label>
                            <asp:Label ID="Label63" runat="server" Text="Permission"></asp:Label>
                        </td>
                    </tr>
                </table>
            </div>
                ...
                <table bgcolor="#F0F0F0" style="border: 1px solid #999999" width="675">
                    <tr>
                        <td height="35" width="30" align="center">
                            <asp:Image ID="Image5" runat="server" ImageUrl="~/Coordinators/Images/info.png" />
                        </td>
                    ...
                    <tr>
                        <td height="35" align="center">
                            <asp:Image ID="Image6" runat="server" ImageUrl="~/Coordinators/Images/info.png" />
                        </td>
                        <td height="35">
                            <asp:Label ID="Label29" runat="server" Font-Bold="True" ForeColor="#CC0000" 
                                Text="Session Subject:"></asp:Label>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td valign="top">
                            <asp:Label ID="Label31" runat="server" Font-Bold="True" ForeColor="#CC0000" 
                                Text="Session Topic:"></asp:Label>
                        </td>
                        <td valign="top">
                            <asp:TextBox ID="TextBoxNotes" runat="server" Height="75px" Width="95%" TextMode="MultiLine"></asp:TextBox>
                        </td>
                        <td valign="top">
