        ...
        <ContentTemplate>
            ...
            <div class="content-right">
                ...
                <asp:SqlDataSource ID="SqlDataSourceListBoxStudents" runat="server" ConnectionString="<%$ ConnectionStrings:SMSOnlineConnectionString %>"
                    SelectCommand="SELECT StudentID, StudentName, Gender, UserName FROM vw_AcademicTermsStudents WHERE (AcademicTermID = @AcademicTermID) AND (SchoolCode = @SchoolCode) AND (SectionCatalogID = @SectionCatalogID) ORDER BY StudentName">
                    <SelectParameters>
                        <asp:ControlParameter ControlID="DropDownListAcademicTermsMaster" Name="AcademicTermID"
                            PropertyName="SelectedValue" />
                        <asp:ControlParameter ControlID="DropDownListSchoolCodesMaster" Name="SchoolCode"
                ...
                <asp:SqlDataSource ID="SqlDataSourceGridViewAssessments" runat="server" ConnectionString="<%$ ConnectionStrings:SMSOnlineConnectionString %>"
                    SelectCommand="SELECT CourseCategory, AssessmentType, Assessment, Date, AssessmentMark AS Score FROM vw_AssessmentsByStudents WHERE (AcademicTermID = @AcademicTermID) AND (StudentID = @StudentID) AND (IsAcademic = 1) ORDER BY CourseCategory, AssessmentType, Assessment">
                    <SelectParameters>
                        <asp:ControlParameter ControlID="DropDownListAcademicTermsMaster" Name="AcademicTermID"
                            PropertyName="SelectedValue" />
