...
<%@ Register Src="MenuUsers.ascx" TagName="MenuUsers" TagPrefix="ucmuc" %>
        ...
        <ContentTemplate>
                ...
                <table class="content-table" width="240">
                    <tr>
                        <td width="60" height="50">
                            <asp:HyperLink ID="HyperLinkStudents" runat="server" 
                                ImageUrl="~/Coordinators/Images/menu_students.png" 
                                NavigateUrl="~/Coordinators/UsersStudents.aspx" ToolTip="Student Details"></asp:HyperLink>
                        </td>
                        <td width="60">
                            <asp:HyperLink ID="HyperLinkAddNewStudent" runat="server" ImageUrl="~/Coordinators/Images/menu_add.png"
                                NavigateUrl="~/Coordinators/UsersStudentsAddNewStudent.aspx" 
                                ToolTip="Add New Student"></asp:HyperLink>
                        </td>
                        <td width="60">
                            <asp:HyperLink ID="HyperLinkUsersCancel" runat="server" 
                                ImageUrl="~/Coordinators/Images/menu_remove.png" 
                                NavigateUrl="~/Coordinators/UsersStudentsCancelledEnrollments.aspx" 
            ...
            <div class="content-right">
                                    ...
                                    <table id="tblBasicInformation" width="100%">
                                        <tr>
                                            ...
                                            <td rowspan="13" valign="top">
                                                <asp:Image ID="ImagePhoto" AlternateText='<%# Eval("UserName") %>' runat="server"
                                                    ImageUrl='<%#"~/SchoolData/StudentPhotos/"+Eval("UserName")+".jpg"%>' Width="190px"
                                                    BorderColor="#666666" BorderStyle="Solid" BorderWidth="1px" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image29" runat="server" ImageUrl="~/Coordinators/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image11" runat="server" ImageUrl="~/Coordinators/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image3" runat="server" ImageUrl="~/Coordinators/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image6" runat="server" ImageUrl="~/Coordinators/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image10" runat="server" ImageUrl="~/Coordinators/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="DropDownListGender" runat="server" SelectedValue='<%# DataBinder.Eval (Container.DataItem, "Gender") %>'
                                                    Width="230px">
                                        ...
                                        <tr>
                                            <td class="style1" height="30">
                                                <asp:Image ID="Image33" runat="server" ImageUrl="~/Coordinators/Images/LeftArrow.png" />
                                            </td>
                                            <td class="style1">
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image34" runat="server" ImageUrl="~/Coordinators/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <asp:RangeValidator ID="RangeValidatorTextBoxPercentage" runat="server" ControlToValidate="TextBoxScholarshipPercentage"
                                                    ErrorMessage="*" MaximumValue="100" MinimumValue="0" SetFocusOnError="True" Type="Integer"></asp:RangeValidator>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td height="30">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Button ID="ButtonUpdate" runat="server" CommandName="Update" Text="Update" Width="230px" />
                                            </td>
                                            <td>
                                                &#160;&#160;
                                            </td>
                                    ...
                                    <table id="tblAdditionalInformation" width="100%">
                                        ...
                                        <tr>
                                            <td class="style1" valign="top" width="20">
                                                <asp:Image ID="Image126" runat="server" ImageUrl="~/Coordinators/Images/LeftArrow.png" />
                                            </td>
                                        ...
                                        <tr>
                                            <td height="28" valign="top" width="20">
                                                <asp:Image ID="Image127" runat="server" ImageUrl="~/Coordinators/Images/LeftArrow.png" />
                                            </td>
                            ...
                            <asp:FormView ID="FormViewStudentsEnrollmentDetails" runat="server" DataKeyNames="StudentID"
                                ...
                                <EditItemTemplate>
                                    <table id="tblEnrollmentDetails0" width="100%">
                                        <tr>
                                            <td height="30" width="20">
                                                <asp:Image ID="Image66" runat="server" ImageUrl="~/Coordinators/Images/LeftArrow.png" />
                                            </td>
                                            <td width="140">
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image67" runat="server" ImageUrl="~/Coordinators/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image68" runat="server" ImageUrl="~/Coordinators/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td height="75" valign="top">
                                                <asp:Image ID="Image71" runat="server" ImageUrl="~/Coordinators/Images/LeftArrow.png" />
                                            </td>
                                        ...
                                        <tr>
                                            <td height="25" valign="top">
                                                <asp:Image ID="Image72" runat="server" ImageUrl="~/Coordinators/Images/LeftArrow.png" />
                                            </td>
                                            <td height="75" valign="top">
                                ...
                                <EditItemTemplate>
                                    <table id="tblGuardiansDetails0" width="100%">
                                        <tr>
                                            ...
                                            <td width="20">
                                                <asp:Image ID="Image124" runat="server" ImageUrl="~/Coordinators/Images/LeftArrow.png" />
                                            </td>
                                            <td width="130">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Image ID="Image125" runat="server" ImageUrl="~/Coordinators/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image46" runat="server" ImageUrl="~/Coordinators/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td height="75" valign="top">
                                                <asp:Image ID="Image47" runat="server" ImageUrl="~/Coordinators/Images/LeftArrow.png" />
                                            </td>
                                            <td valign="top">
                                        ...
                                        <tr>
                                            <td height="75" valign="top">
                                                <asp:Image ID="Image49" runat="server" ImageUrl="~/Coordinators/Images/LeftArrow.png" />
                                            </td>
                                            <td valign="top">
                            ...
                            <asp:FormView ID="FormViewParentsParentsInformation" runat="server" DataSourceID="SqlDataSourceFormViewParentsParentsInformation"
                                ...
                                <EditItemTemplate>
                                    <table id="StudentTable1" width="100%">
                                        <tr>
                                            <td height="30" width="20">
                                                <asp:Image ID="Image128" runat="server" ImageUrl="~/Coordinators/Images/LeftArrow.png" />
                                            </td>
                                            <td width="130">
                                        ...
                                        <tr>
                                            <td height="30" valign="top">
                                                <asp:Image ID="Image131" runat="server" ImageUrl="~/Coordinators/Images/LeftArrow.png" />
                                            </td>
                                            <td valign="top">
                                            ...
                                            <td valign="top">
                                                <asp:Image ID="Image132" runat="server" ImageUrl="~/Coordinators/Images/LeftArrow.png" />
                                            </td>
                                            <td valign="top">
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image133" runat="server" ImageUrl="~/Coordinators/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <asp:TextBox ID="TextBoxFatherDateofBirth" runat="server" meta:resourcekey="TextBoxStartingGradeResource1"
                                                    Text='<%# Bind("FatherDateofBirth") %>' Width="150px"></asp:TextBox><asp:CalendarExtender
                                                        ID="TextBoxFatherDateofBirth_CalendarExtender1" runat="server" TargetControlID="TextBoxFatherDateofBirth">
                                                    </asp:CalendarExtender>
                                            ...
                                            <td>
                                                <asp:Image ID="Image134" runat="server" ImageUrl="~/Coordinators/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <asp:TextBox ID="TextBoxMotherDateofBirth" runat="server" meta:resourcekey="TextBoxStartingGradeResource1"
                                                    Text='<%# Bind("MotherDateofBirth") %>' Width="140px"></asp:TextBox><asp:CalendarExtender
                                                        ID="TextBoxMotherDateofBirth_CalendarExtender1" runat="server" TargetControlID="TextBoxMotherDateofBirth">
                                                    </asp:CalendarExtender>
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image135" runat="server" ImageUrl="~/Coordinators/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <asp:Image ID="Image136" runat="server" ImageUrl="~/Coordinators/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image137" runat="server" ImageUrl="~/Coordinators/Images/LeftArrow.png" />
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td height="30">
                                                <asp:Image ID="Image138" runat="server" ImageUrl="~/Coordinators/Images/LeftArrow.png" />
                                            </td>
                                            <td height="28">
                ...
                <asp:SqlDataSource ID="SqlDataSourceListBoxStudents" runat="server" ConnectionString="<%$ ConnectionStrings:SMSOnlineConnectionString %>"
                    SelectCommand="SELECT StudentID, StudentName, Gender, UserName, SectionCatalogID FROM vw_AcademicTermsStudents WHERE (AcademicTermID = @AcademicTermID) AND (SchoolCode = @SchoolCode) AND (SectionSchool = @IsSD OR SectionSchool = @IsSMP OR SectionSchool = @IsSMA) ORDER BY StudentName"
