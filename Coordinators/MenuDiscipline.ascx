...
<table class="content-table" width="240">
    ...
    <tr>
        <td height="50" width="50">
            <asp:HyperLink ID="HyperLinkDisciplineChecklist" runat="server" ImageUrl="~/Coordinators/Images/menu_discipline_checklist.png"
                NavigateUrl="~/Coordinators/DisciplineChecklist.aspx" ToolTip="Discipline Checklist"></asp:HyperLink>
        </td>
        <td width="50">
            <asp:HyperLink ID="HyperLinkBehaviorPoints" runat="server" ImageUrl="~/Coordinators/Images/menu_average_calculation.png"
                NavigateUrl="~/Coordinators/DisciplineStudentPoints.aspx" ToolTip="Behavior Points"></asp:HyperLink>
        </td>
        <td width="50">
            
            <asp:HyperLink ID="HyperLinkAddBonusPoints" runat="server" ImageUrl="~/Coordinators/Images/menu_discipline_bonus.png"
                NavigateUrl="~/Coordinators/DisciplineAddBonusPoints.aspx" ToolTip="Add Bonus Points"></asp:HyperLink>
        </td>
        <td>
            <asp:HyperLink ID="HyperLinkAddOffensePoints" runat="server" ImageUrl="~/Coordinators/Images/menu_discipline_offense.png"
                NavigateUrl="~/Coordinators/DisciplineAddDisciplinePoints.aspx" ToolTip="Add Offense Points"></asp:HyperLink>
