        ...
        <ContentTemplate>
            <div class="content-left">
                ...
                <table class="content-table" width="240">
                    <tr>
                        <td height="28">
                            <asp:Label ID="Label36" runat="server" Font-Bold="True" ForeColor="Red" 
                                Text="Select School Level"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td height="28">
                            <asp:Label ID="Label135" runat="server" Font-Bold="True" ForeColor="Red" 
                                Text="Select School Section"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td height="28">
                            <asp:Label ID="Label134" runat="server" Font-Bold="True" 
                                Text="Select Section Course" ForeColor="Red"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>
                ...
                <div id="divChild">
                    <table width="675" class="content-table">
                        <tr>
                            <td align="left" height="50">
                                <asp:Label ID="Label133" runat="server" Font-Bold="True" ForeColor="Red" Text="Given Assessments"
                    ...
                    <table width="675" class="content-table">
                        <tr>
                            ...
                            <td width="40">
                                <asp:ImageButton ID="ImageButtonExcel" runat="server" ImageUrl="~/Coordinators/Images/export_excel.png" />
                            </td>
                            <td width="40">
                                <asp:ImageButton ID="ImageButtonWord" runat="server" ImageUrl="~/Coordinators/Images/export_word.png" />
                            </td>
                            <td width="40">
                                <asp:ImageButton ID="ImageButtonPDF" runat="server" ImageUrl="~/Coordinators/Images/export_pdf.png" />
                            </td>
                        </tr>
                    </table>
                    <br />
                    <asp:GridView ID="GridViewAssessmentsMarks" runat="server" AutoGenerateColumns="False"
                        DataSourceID="SqlDataSourceAssessmentsMarks" Width="675px" Font-Size="9pt" Font-Names="Arial">
                        <Columns>
                    ...
                    <asp:SqlDataSource ID="SqlDataSourceSections" runat="server" ConnectionString="<%$ ConnectionStrings:SMSOnlineConnectionString %>"
                        SelectCommand="SELECT SectionCatalogID, SectionCatalog, SectionSchool FROM vw_Sections WHERE (SchoolCode = @SchoolCode) AND (SectionSchool = @SectionSchool) ORDER BY SectionGroup">
                        <SelectParameters>
