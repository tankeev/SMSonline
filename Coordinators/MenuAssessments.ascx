...
<table class="content-table" width="240">
    <tr>
        <td height="50" width="50">
            <asp:HyperLink ID="HyperLinkAssessmentsByStudents" runat="server" ImageUrl="~/Coordinators/Images/menu_assessments_students.png"
                NavigateUrl="~/Coordinators/AssessmentsByStudents.aspx"></asp:HyperLink>
        </td>
        <td width="50">
            <asp:HyperLink ID="HyperLinkAssessmentsByCourses" runat="server" ImageUrl="~/Coordinators/Images/menu_assessments_courses.png"
                NavigateUrl="~/Coordinators/AssessmentsByCourses.aspx"></asp:HyperLink>
        </td>
        <td width="50">
            <asp:HyperLink ID="HyperLinkAssessmentsTeachers" runat="server" ImageUrl="~/Coordinators/Images/menu_assessments_teachers.png"
                NavigateUrl="~/Coordinators/AssessmentsByTeachers.aspx"></asp:HyperLink>
        </td>
        <td>
            <asp:HyperLink ID="HyperLinkAssessmentsTypes" runat="server" ImageUrl="~/Coordinators/Images/menu_assessments_types.png"
...
<div id="divPanels">
    ...
    <asp:Panel ID="PanelInfoAssessmentsTeachers" runat="server" CssClass="MenuToolTip"
        Style="display: none;" Width="230">
        <asp:Label ID="Label4" runat="server" Text="Assessments By Teachers" ForeColor="Red"
            Font-Bold="True"></asp:Label>
        <br />
        <br />
