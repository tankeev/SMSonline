        ...
        <ContentTemplate>
            <div class="content-left">
                ...
                <table class="content-table" width="240">
                    ...
                    <tr>
                        <td width="40">
                            <asp:HyperLink ID="HyperLinkView0" runat="server" ImageUrl="~/Coordinators/Images/menu_view.png"
                                NavigateUrl="~/Coordinators/AttendanceTotal.aspx"></asp:HyperLink>
                        </td>
                        <td>
                            <asp:Label ID="Label34" runat="server" Text="Attendance Summary"></asp:Label>
                        </td>
                    </tr>
                </table>
                <br />
                <table class="content-table" width="240">
                    ...
                    <tr>
                        <td height="28">
                            <asp:Label ID="Label128" runat="server" Font-Bold="True" Text="Select Student"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td height="28">
            ...
            <div class="content-right">
                ...
                <asp:GridView ID="GridViewAttendanceReports" runat="server" AutoGenerateColumns="False"
                    DataSourceID="SqlDataSourceAttendanceReports" Width="675px" DataKeyNames="StudentID"
                ...
                <asp:SqlDataSource ID="SqlDataSourceStudents" runat="server" ConnectionString="<%$ ConnectionStrings:SMSOnlineConnectionString %>"
                    ...
                    SelectCommand="SELECT StudentID, StudentName FROM vw_AcademicTermsStudents WHERE (SectionCatalogID = @SectionCatalogID) AND (AcademicTermID = @AcademicTermID) AND (SchoolCode = @SchoolCode)"
