<%@ Page Title="SIS Add New Student" Language="VB" MasterPageFile="~/Site.Master"
    CodeFile="UsersStudentsAddNewStudent.aspx.vb" Inherits="NewUserAccount" %>
        ...
        <ContentTemplate>
            ...
            <div class="content-right">
                <h2>
                    ADMISSION FORM</h2>
                <br />
                <asp:CreateUserWizard ID="CreateUserWizardStudent" runat="server" ContinueDestinationPageUrl="~/Coordinators/UsersStudentsAddNewStudent.aspx"
                    LoginCreatedUser="False" Width="680px">
                    <WizardSteps>
                        <asp:CreateUserWizardStep runat="server">
                            <ContentTemplate>
                                <asp:Label ID="Label3" runat="server" Text="Coordinators INFORMATION" Font-Bold="True"
                                    ForeColor="Maroon"></asp:Label>
                                <br />
                                <br />
                                <table id="CoordinatorsTable" width="100%">
                                    <tr>
                                        ...
                                        <td rowspan="8" valign="top">
                                            <asp:Image ID="ImageStaff" runat="server" ImageUrl="~/Coordinators/Images/Student.png"
                                                Width="240px" />
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td height="28">
                                            <asp:Image ID="Image19" runat="server" ImageUrl="~/Coordinators/Images/LeftArrow.png" />
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td height="28">
                                            <asp:Image ID="Image20" runat="server" ImageUrl="~/Coordinators/Images/LeftArrow.png" />
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList ID="DropDownListRoles" runat="server" TabIndex="7" Width="230px"
                                                Enabled="False">
                                            </asp:DropDownList>
                                        </td>
                                    </tr>
                                ...
                                <br />
                                <br />
                                <table id="CoordinatorsTable0" width="100%">
                                    <tr>
                                        <td width="20" height="28">
                                            <asp:Image ID="Image56" runat="server" ImageUrl="~/Coordinators/Images/LeftArrow.png" />
                                        </td>
                                        <td width="140">
                                            <asp:Label ID="Label35" runat="server" meta:resourcekey="Label1Resource1" Text="School No: (Induk)"></asp:Label>
                                        </td>
                                        <td width="250">
                                            <asp:TextBox ID="TextBoxSchoolNo" runat="server" TabIndex="8" Width="220px"></asp:TextBox>
                                        </td>
                                        <td>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList ID="DropDownListSchools" runat="server" DataSourceID="SqlDataSourceSchools"
                                                DataTextField="SchoolName" DataValueField="SchoolCode" Enabled="False" TabIndex="9"
                                                Width="230px">
                                            </asp:DropDownList>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td height="28">
                                            <asp:Image ID="Image112" runat="server" ImageUrl="~/Coordinators/Images/LeftArrow.png" />
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <asp:TextBox ID="TextBoxStudentName" runat="server" MaxLength="50" meta:resourcekey="TextBoxStudentNameResource1"
                                                Text='<%# Bind("StudentName") %>' Width="220px" TabIndex="10"></asp:TextBox>
                                    ...
                                    <tr>
                                        <td height="28">
                                            <asp:Image ID="Image113" runat="server" ImageUrl="~/Coordinators/Images/LeftArrow.png" />
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <asp:TextBox ID="TextBoxDateofBirth" runat="server" MaxLength="50" meta:resourcekey="TextBoxStudentNameResource1"
                                                Text='<%# Bind("DateofBirth", "{0:d}") %>' Width="220px" TabIndex="11"></asp:TextBox>
                                    ...
                                    <tr>
                                        <td height="28">
                                            <asp:Image ID="Image114" runat="server" ImageUrl="~/Coordinators/Images/LeftArrow.png" />
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <asp:TextBox ID="TextBoxPlaceofBirth" runat="server" MaxLength="50" meta:resourcekey="TextBoxSexResource1"
                                                Text='<%# Bind("BirthPlace") %>' Width="220px" TabIndex="12"></asp:TextBox>
                                        </td>
                                        <td>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td height="28">
                                            <asp:Image ID="Image115" runat="server" ImageUrl="~/Coordinators/Images/LeftArrow.png" />
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td height="28">
                                            <asp:Image ID="Image116" runat="server" ImageUrl="~/Coordinators/Images/LeftArrow.png" />
                                        </td>
                                        <td>
                                            <asp:Label ID="Label43" runat="server" Text="Religion:"></asp:Label>
                                        </td>
                                        <td>
                                            <asp:TextBox ID="TextBoxReligion" runat="server" MaxLength="50" TabIndex="14" 
                                    ...
                                    <tr>
                                        <td height="28">
                                            <asp:Image ID="Image58" runat="server" ImageUrl="~/Coordinators/Images/LeftArrow.png" />
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <asp:DropDownList ID="DropDownListSections" runat="server" DataSourceID="SqlDataSourceSections"
                                                DataTextField="SectionCatalog" DataValueField="SectionCatalogID" TabIndex="15"
                                                Width="230px">
                                            </asp:DropDownList>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList ID="DropDownListAcademicTerms" runat="server" DataSourceID="SqlDataSourceAcademicTerms"
                                                DataTextField="AcademicTerm" DataValueField="AcademicTermID" TabIndex="16" 
                                                Width="230px">
                                            </asp:DropDownList>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:CheckBox ID="CheckBoxOlympiad" runat="server" Checked='<%# Bind("IsOlympiad") %>'
                                                Text="Is Olympiad Student?" TabIndex="17" />
                                        </td>
                                        <td>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td height="28">
                                            <asp:Image ID="Image101" runat="server" ImageUrl="~/Coordinators/Images/LeftArrow.png" />
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <asp:TextBox ID="TextBoxOlympiadName" runat="server" MaxLength="50" meta:resourcekey="TextBoxSexResource1"
                                                Text='<%# Bind("BirthPlace") %>' Width="220px" TabIndex="18"></asp:TextBox>
                                        </td>
                                        <td>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <asp:CheckBox ID="CheckBoxScholarship" runat="server" Checked='<%# Bind("IsScholarship") %>'
                                                Text="Has Scholarship?" TabIndex="19" />
                                        </td>
                                        <td>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td height="28">
                                            <asp:Image ID="Image117" runat="server" ImageUrl="~/Coordinators/Images/LeftArrow.png" />
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <asp:TextBox ID="TextBoxScholarshipPercentage" runat="server" MaxLength="50" meta:resourcekey="TextBoxSexResource1"
                                                Text='<%# Bind("BirthPlace") %>' Width="220px" TabIndex="20"></asp:TextBox>
                                        ...
                                        <td>
                                            <asp:TextBox ID="TextBoxSliderValue" runat="server" Width="35px" TabIndex="21"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td height="28">
                                            <asp:Image ID="Image118" runat="server" ImageUrl="~/Coordinators/Images/LeftArrow.png" />
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <asp:TextBox ID="TextBoxStudentContactPhone" runat="server" MaxLength="50" meta:resourcekey="TextBoxSexResource1"
                                                Text='<%# Bind("BirthPlace") %>' Width="220px" TabIndex="22"></asp:TextBox>
                                        </td>
                                        <td>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td height="28">
                                            <asp:Image ID="Image120" runat="server" ImageUrl="~/Coordinators/Images/LeftArrow.png" />
                                        </td>
                                        <td>
                                ...
                                <table id="StudentTable" width="100%">
                                    ...
                                    <tr>
                                        <td height="28">
                                            <asp:Image ID="Image60" runat="server" ImageUrl="~/Coordinators/Images/LeftArrow.png" />
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:Image ID="Image2" runat="server" ImageUrl="~/Coordinators/Images/LeftArrow.png" />
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:Image ID="Image69" runat="server" ImageUrl="~/Coordinators/Images/LeftArrow.png" />
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td height="28">
                                            <asp:Image ID="Image8" runat="server" ImageUrl="~/Coordinators/Images/LeftArrow.png" />
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <asp:Image ID="Image41" runat="server" ImageUrl="~/Coordinators/Images/LeftArrow.png" />
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:Image ID="Image43" runat="server" ImageUrl="~/Coordinators/Images/LeftArrow.png" />
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:Image ID="Image44" runat="server" ImageUrl="~/Coordinators/Images/LeftArrow.png" />
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:Image ID="Image45" runat="server" ImageUrl="~/Coordinators/Images/LeftArrow.png" />
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td height="28">
                                            <asp:Image ID="Image35" runat="server" ImageUrl="~/Coordinators/Images/LeftArrow.png" />
                                        </td>
                                        <td height="28">
                                        ...
                                        <td height="28">
                                            <asp:Image ID="Image38" runat="server" ImageUrl="~/Coordinators/Images/LeftArrow.png" />
                                        </td>
                                ...
                                <table id="StudentTable0" width="100%">
                                    <tr>
                                        <td height="28" width="20">
                                            <asp:Image ID="Image70" runat="server" ImageUrl="~/Coordinators/Images/LeftArrow.png" />
                                        </td>
                                        <td width="140">
                                    ...
                                    <tr>
                                        <td height="28" width="20">
                                            <asp:Image ID="Image119" runat="server" ImageUrl="~/Coordinators/Images/LeftArrow.png" />
                                        </td>
                                        <td width="140">
                                    ...
                                    <tr>
                                        <td height="28">
                                            <asp:Image ID="Image102" runat="server" ImageUrl="~/Coordinators/Images/LeftArrow.png" />
                                        </td>
                                        <td height="28">
                                ...
                                <table id="StudentTable1" width="100%">
                                    ...
                                    <tr>
                                        <td height="75" valign="top">
                                            <asp:Image ID="Image111" runat="server" ImageUrl="~/Coordinators/Images/LeftArrow.png" />
                                        </td>
                                        <td valign="top">
                                ...
                                <table width="100%">
                                    <tr>
                                        <td align="center" height="25">
                                            <asp:Image ID="Image22" runat="server" ImageUrl="~/Coordinators/Images/success.png" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="center" height="25">
