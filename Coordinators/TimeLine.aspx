    ...
    <asp:UpdatePanel ID="UpdatePanel" runat="server">
        <ContentTemplate>
                            ...
                            <asp:GridView ID="GridViewGroups" runat="server" AutoGenerateColumns="False" DataKeyNames="DashBoardGroupID"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Group Name">
                                        <ItemTemplate>
                                            <asp:Label ID="LabelGroupName" runat="server" 
                                                Text='<%# Bind("DashBoardGroupName") %>' Font-Size="X-Small"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
            ...
            <div class="content-right">
                                ...
                                <table width="100%">
                                    <tr>
                                        <td height="25" width="25" align="center">
                                            <asp:Image ID="Image2" runat="server" ImageUrl="~/Coordinators/Images/row.gif" />
                                        </td>
                                        <td height="25">
                ...
                <br />
                <uc1:WebMessageBox ID="WebMessageBoxTimeLine" runat="server" />
                <br />
